    ...
    render() {
        ...
        return (
            ...
            <React.Fragment>
                ...
                <View style={{ flexDirection: "row", width: Scales.deviceWidth*1.0, height: Scales.deviceHeight*0.07, backgroundColor: '#483da8', alignItems: 'center', }}>
                    ...
                    <View style={{ width: widths, height: Scales.deviceHeight*0.07,justifyContent: 'flex-end',alignItems:'center' ,alignContent: 'center',  flexDirection: 'row', backgroundColor:'white'}}>
