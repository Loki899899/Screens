        ...
        return (
            ...
            <React.Fragment>
                ...
                <View style={{ flexDirection: "row", width: Scales.deviceWidth*1.0, height: Scales.deviceHeight*0.07, backgroundColor: '#2c2c39', alignItems: 'center', }}>
                    ...
                    {!this.props.back?<TouchableOpacity style={{ width: Scales.deviceWidth*0.12, height: Scales.deviceHeight*0.065,}} onPress={() => this.BackMethod()}><View style={{ width: Scales.deviceWidth*0.12,zIndex:100, height: Scales.deviceHeight*0.065, justifyContent: 'center', paddingLeft: 10, }}>
