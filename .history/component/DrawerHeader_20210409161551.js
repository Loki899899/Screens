...
export default class Header extends Component {
    ...
    render() {
        ...
        return (
            ...
            <React.Fragment>
                <StatusBar backgroundColor="#2d2d3a" barStyle="light-content" />
                <View style={{ flexDirection: "row", width: Scales.deviceWidth*1.0, height: Scales.deviceHeight*0.07, backgroundColor: '#2c2c39', alignItems: 'center', }}>
                    ...
                    <View style={{ width: widths, height: Scales.deviceHeight*0.07,justifyContent: 'flex-end',alignItems:'center' ,alignContent: 'center',  flexDirection: 'row',}}>
                        ...
                        {this.props.searchoff!=undefined?<View style={{width:Scales.deviceWidth*0.08, height:Scales.deviceHeight*0.035, borderRadius:5, alignSelf:'center',justifyContent:'center'}}>
                            <TouchableWithoutFeedback onPress={this.props.Click_Search}><Image source ={require('../assets/JobmaIcons/search-dark-theme.png')} style={{resizeMode:'contain', alignSelf:'center', width:Scales.deviceWidth*0.05, height:Scales.deviceHeight*0.02}} /></TouchableWithoutFeedback>
