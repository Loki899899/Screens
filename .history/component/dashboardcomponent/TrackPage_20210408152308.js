        ...
        return (
            <SafeAreaView style={{ flex: 1 }}>
                <View style={{ flex: 1, backgroundColor: "#2c2c39" }} >
                    ...
                    {this.state.back ?
                        <Header heading="Track" {...this.props} textalign='center' left={Scales.deviceWidth * 0.08} back={null} backfunc={backfunc} /> : <Header heading="Track" {...this.props} textalign='center' left={Scales.deviceWidth * 0.08} backfunc={backfunc} />}
                    <View style={{ width: Scales.deviceWidth * 1.0, }}>
                        <View style={{ width: Scales.deviceWidth * 1.0, height: Scales.deviceHeight * 0.08, flexDirection: "row", justifyContent: "center",}}>
                            <View style={{ width: Scales.deviceWidth * 0.75, height: Scales.deviceHeight * 0.06, borderRadius: 5, alignSelf: 'center' }}>
                                <TextInput onChangeText={(text) => this.searchJobFilterFunction(text)} placeholderTextColor={"#3c3c3c"} value={this.state.seleted_job_name} style={{ width: Scales.deviceWidth * 0.75, paddingLeft: Scales.deviceWidth * 0.028, fontFamily: "roboto-medium", height: Scales.deviceHeight * 0.0595, borderRadius: 5, backgroundColor: "#f9f9f9", borderBottomRightRadius: 0, borderTopRightRadius: 0, borderRightWidth: 0, borderWidth: 0.5, fontSize: Scales.moderateScale(14), color: "#3c3c3c" }} placeholder={"Jobs"} />
                            </View>
                            <View style={{ width: Scales.deviceWidth * 0.20, height: Scales.deviceHeight * 0.06, justifyContent: "center", borderRadius: 5, borderWidth: 0.5, alignSelf: 'center', backgroundColor: "#f9f9f9", borderLeftWidth: 0, borderTopLeftRadius: 0, borderBottomLeftRadius: 0 }}>
