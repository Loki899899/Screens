        ...
        return (
            <SafeAreaView style={{ flex: 1 }}>
                <View style={{ flex: 1, backgroundColor: "#2c2c39" }} >
                    ...
                    {this.state.back ?
                        <Header heading="Track" {...this.props} textalign='center' left={Scales.deviceWidth * 0.08} back='abc' backfunc={backfunc} /> : <Header heading="Track" {...this.props} textalign='center' left={Scales.deviceWidth * 0.08} backfunc={backfunc} />}
