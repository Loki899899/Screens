                ...
                <View style={{ flex: 1, backgroundColor: "#2c2c39" }} >
                    ...
                    <View style={{ width: Scales.deviceWidth * 1.0, }}>
                        <View style={{ width: Scales.deviceWidth * 1.0, height: Scales.deviceHeight * 0.08, flexDirection: "row", justifyContent: "center",}}>
                            ...
                            <View style={{ width: Scales.deviceWidth * 0.20, height: Scales.deviceHeight * 0.06, justifyContent: "center", borderRadius: 5, borderWidth: 0.5, alignSelf: 'center', backgroundColor: "#f9f9f9", backgroundColor:'green',borderLeftWidth: 0, borderTopLeftRadius: 0, borderBottomLeftRadius: 0 }}>
