                    ...
                    <View style={{ width: Scales.deviceWidth * 1.0, }}>
                        <View style={{ width: Scales.deviceWidth * 1.0, height: Scales.deviceHeight * 0.08, flexDirection: "row", justifyContent: "center",}}>
                            <View style={{ width: Scales.deviceWidth * 0.75, height: Scales.deviceHeight * 0.06, borderRadius: 5, alignSelf: 'center' }}>
                                <TextInput onChangeText={(text) => this.searchJobFilterFunction(text)} placeholderTextColor={"#3c3c3c"} value={this.state.seleted_job_name} style={{ backgroundColor:'#3d3d46', width: Scales.deviceWidth * 0.75, paddingLeft: Scales.deviceWidth * 0.028, fontFamily: "roboto-medium", height: Scales.deviceHeight * 0.0595, borderRadius: 5, borderBottomRightRadius: 0, borderTopRightRadius: 0, borderRightWidth: 0, borderWidth: 0.5, fontSize: Scales.moderateScale(14), color: "white" }} />
                                <Image
                                    source={require('./../../assets/JobmaIcons/search-dark-theme.png')}
                                    style={{width:12, height:12, position:'absolute',top:'36%', left:'4%'}}
                                ></Image>
                            </View>
