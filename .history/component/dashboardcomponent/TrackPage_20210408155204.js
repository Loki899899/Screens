                    ...
                    <View style={{ width: Scales.deviceWidth * 1.0, }}>
                        <View style={{ width: Scales.deviceWidth * 1.0, height: Scales.deviceHeight * 0.08, flexDirection: "row", justifyContent: "center",}}>
                            <View style={{ width: Scales.deviceWidth * 0.75, height: Scales.deviceHeight * 0.06, borderRadius: 5, alignSelf: 'center' }}>
                                ...
                                <View style={{ position:'absolute',top:'36%', left:'2%'}}>
                                <Image
    ...
    render() {
        ...
        return (
            <View style={{ width: Scales.deviceWidth * 1.0, height: Scales.deviceHeight * 0.18, justifyContent: "center", alignSelf: "center" }}>
                <View style={{ width: Scales.deviceWidth * 0.95, alignSelf: "center", height: Scales.deviceHeight * 0.17, backgroundColor: "#3d3d46", elevation: 9, borderRadius: 5, padding: 5, paddingTop: 10, flexDirection: "row",shadowOffset: { width: 0, height: 1 },
                                                            shadowOpacity: 0.1,
                                                            shadowRadius: 1 }}>
                    <View style={{ width: Scales.deviceWidth * 0.18, height: Scales.deviceHeight * 0.19, paddingTop: Scales.deviceHeight * 0.01, paddingLeft: Scales.deviceHeight * 0.01 }}>
                        <View style={{ width: Scales.deviceHeight * 0.07, justifyContent: "center", height: Scales.deviceHeight * 0.07, borderRadius: (Scales.deviceHeight * 0.07) / 2, backgroundColor: this.state.image == "" ? "#ffa001" : "transparent", }}>
                            {this.state.image == "" ?
                                <Text style={{ fontSize: Scales.moderateScale(14), textTransform: "capitalize", fontFamily: "roboto-medium", color: "blue", alignSelf: "center" }}>{this.props.data.pitcher.pitcher_fname.slice(0, 2)}</Text> :
                    ...
                    <View style={{ width: Scales.deviceWidth * 0.74, height: Scales.deviceHeight * 0.19 }}>
                        ...
                        <View style={{ alignItems: "center", flexDirection: "row", }}>
                            <Text style={{ fontFamily: "roboto-regular", fontSize: Scales.moderateScale(14), paddingLeft: 8, color: "white" }}>
                                <Text style={{ fontFamily: "roboto-bold", color: "#3c3c3c" }}>{this.props.data.pitcher.pitcher_fname} {this.props.data.pitcher.pitcher_lname}</Text> Invited for <Text style={{ fontFamily: "roboto-bold", color:'white'}}>{this.props.data.job.job_title}  </Text>
                                <Text>
