                ...
                <View style={{ flex: 1, backgroundColor: "#2c2c39" }} >
                    ...
                    <View style={{ width: Scales.deviceWidth * 1.0, }}>
                        <View style={{ width: Scales.deviceWidth * 1.0, height: Scales.deviceHeight * 0.08, flexDirection: "row", justifyContent: "center",}}>
                            <View style={{ width: Scales.deviceWidth * 0.75, height: Scales.deviceHeight * 0.06, borderRadius: 5, alignSelf: 'center' }}>
                                <TextInput onChangeText={(text) => this.searchJobFilterFunction(text)} value={this.state.seleted_job_name} style={{ backgroundColor: '#3d3d46', width: Scales.deviceWidth * 0.75, paddingLeft: Scales.deviceWidth * 0.06, fontFamily: "roboto-medium", height: Scales.deviceHeight * 0.0595, borderRadius: 5, borderBottomRightRadius: 0, borderTopRightRadius: 0, borderRightWidth: 0, borderWidth: 0.5, fontSize: Scales.moderateScale(14), color: "white" }} />
                            ...
                            <View style={{ width: Scales.deviceWidth * 0.20, height: Scales.deviceHeight * 0.06, justifyContent: "center", borderRadius: 5, borderWidth: 0.5, alignSelf: 'center', backgroundColor:'#3d3d46',borderLeftWidth: 0, borderTopLeftRadius: 0, borderBottomLeftRadius: 0 }}>
                                <TouchableOpacity onPress={() => this.setState({ jobs_show: !this.state.jobs_show })}><Image source={require("../../assets/Images/drop-down.png")} style={{ alignSelf: 'center' }} /></TouchableOpacity>
                            </View>
                        </View>
...
class InterviewList extends Component {
    ...
    render() {
        ...
        return (
            <View style={{ width: Scales.deviceWidth * 1.0, height: Scales.deviceHeight * 0.18, justifyContent: "center", alignSelf: "center" }}>
                <View style={{ width: Scales.deviceWidth * 0.95, alignSelf: "center", height: Scales.deviceHeight * 0.17, backgroundColor: "white", elevation: 9, borderRadius: 5, padding: 5, paddingTop: 10, flexDirection: "row",shadowOffset: { width: 0, height: 1 },
                                                            shadowOpacity: 0.1,
                                                            shadowRadius: 1 }}>
                    <View style={{ width: Scales.deviceWidth * 0.18, height: Scales.deviceHeight * 0.19, paddingTop: Scales.deviceHeight * 0.01, paddingLeft: Scales.deviceHeight * 0.01 }}>
                        <View style={{ width: Scales.deviceHeight * 0.07, justifyContent: "center", height: Scales.deviceHeight * 0.07, borderRadius: (Scales.deviceHeight * 0.07) / 2, backgroundColor: this.state.image == "" ? "#ffa001" : "transparent", }}>
                            {this.state.image == "" ?
                                ...
                                <Image onError={() => { this.setState({ image: "" }) }} source={{ uri: this.props.data.pitcher.pitcher_url }} style={{ width: Scales.deviceHeight * 0.07, height: Scales.deviceHeight * 0.07, borderRadius: (Scales.deviceHeight * 0.07) / 2 }} />}
                        </View>
                        <View style={{width: Scales.deviceHeight * 0.08, backgroundColor:'green'}}>
                        <Text>
                            <Text style={{ width: Scales.deviceHeight * 0.08, backgroundColor: this.props.data.jobma_interview_status == 0 ? "#fff2bc" : this.props.data.jobma_interview_status == 1 ? "#def3ff" : this.props.data.jobma_interview_status == 2 ? "#cdffbc" : expired_flag ? "#f9e7eb" : this.props.data.jobma_interview_status == 3 ? "#f9e7eb" : this.props.data.jobma_interview_status == 4 ? "#f9e7eb" : this.props.data.jobma_interview_status == 5 ? "#cdffbc" : null, }}>
                                <Text style={{ width: Scales.deviceHeight * 0.08,textAlign: "center", fontSize: Scales.moderateScale(9), fontFamily: "roboto-medium", color: this.props.data.jobma_interview_status == 0 ? "#ffa001" : this.props.data.jobma_interview_status == 1 ? "#6eaff1" : this.props.data.jobma_interview_status == 2 ? "#5eb442" : expired_flag == 3 ? "#dc3a59" : this.props.data.jobma_interview_status == 3 ? "#dc3a59" : this.props.data.jobma_interview_status == 4 ? "#dc3a59" : this.props.data.jobma_interview_status == 5 ? "#5eb442" : null, borderRadius: 10 }}>{this.props.data.jobma_interview_status == 0 ? "    Invited" : this.props.data.jobma_interview_status == 1 ? "    In Progress" : this.props.data.jobma_interview_status == 2 ? "   Completed" : expired_flag ? "    Expired  " : this.props.data.jobma_interview_status == 3 ? "    Expired  " : this.props.data.jobma_interview_status == 4 ? "  Rejected  " : this.props.data.jobma_interview_status == 5 ? "   Rescheduled   " : null}    </Text>
                            </Text>
                        </Text>
                        </View>
                    </View>
                    <View style={{ width: Scales.deviceWidth * 0.74, height: Scales.deviceHeight * 0.19 }}>
                        ...
                        <View style={{ width: Scales.deviceWidth * 0.74, height: Scales.deviceHeight * 0.13, flexDirection: 'row' }}>
                            <View style={{ width: Scales.deviceWidth * 0.47, height: Scales.deviceHeight * 0.13, }}>
                                ...
                                <View style={{ width: Scales.deviceWidth * 0.47, height: Scales.deviceHeight * 0.03, flexDirection: "row" }}>
                                    <View style={{ height: Scales.deviceHeight * 0.03, alignSelf: "center", width: Scales.deviceWidth * 0.085, justifyContent: "center" }}>
                                    ...
                                    <View style={{ height: Scales.deviceHeight * 0.03, width: Scales.deviceWidth * 0.385, paddingTop: Scales.deviceHeight * 0.005 }}>
