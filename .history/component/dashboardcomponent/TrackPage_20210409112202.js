    ...
    render() {
        ...
        return (
            <View style={{ width: Scales.deviceWidth * 1.0, height: Scales.deviceHeight * 0.18, justifyContent: "center", alignSelf: "center" }}>
                ...
                <View style={{ width: Scales.deviceWidth * 0.92, alignSelf: "center", height: Scales.deviceHeight * 0.17, backgroundColor: "white", elevation: 9, borderRadius: 5, padding: Scales.deviceHeight * 0.01, paddingTop: 10, flexDirection: "row",shadowOffset: { width: 0, height: 1 },
                                                            shadowOpacity: 0.1,
                                                            shadowRadius: 1 }}>
