...
class InterviewList extends Component {
    ...
    render() {
        ...
        return (
            <View style={{ width: Scales.deviceWidth * 1.0, height: Scales.deviceHeight * 0.155, justifyContent: "center", alignSelf: "center" }}>
                {/* TO REMOVE SHADOW IF ASKED */}
                <View style={{ width: Scales.deviceWidth * 0.92, alignSelf: "center", height: Scales.deviceHeight * 0.14, backgroundColor: "green", elevation: 9, borderRadius: 5, padding: 5, paddingTop: 10, flexDirection: "row",shadowOffset: { width: 0, height: 1 },
                                                            shadowOpacity: 0.1,
                                                            shadowRadius: 1 ,
                                                            paddingLeft:Scales.deviceHeight * 0.01}}>
                    <View style={{ backgroundColor:'grey',width: Scales.deviceWidth * 0.18, height: Scales.deviceHeight * 0.12, paddingTop: Scales.deviceHeight * 0.01, paddingLeft: Scales.deviceHeight * 0.01 }}>
