...
class InterviewList extends Component {
    ...
    render() {
        ...
        return (
            // CHANGED HEIGHT TO minHeight FOR CONTENT TO BE ABLE TO FIT
            <View style={{ width: Scales.deviceWidth * 1.0, minHeight: Scales.deviceHeight * 0.16, justifyContent: "center", alignSelf: "center" }}>
                {/* TO REMOVE SHADOW IF ASKED */}
                <View style={{ width: Scales.deviceWidth * 0.92, alignSelf: "center", minHeight: Scales.deviceHeight * 0.15, backgroundColor: "green", elevation: 9, borderRadius: 5, padding: 5, paddingTop: 10, paddingBottom:1, flexDirection: "row",shadowOffset: { width: 0, height: 1 },
                                                            shadowOpacity: 0.1,
                                                            shadowRadius: 1 ,
                                                            paddingLeft:Scales.deviceHeight * 0.02}}>
                    <View style={{ backgroundColor:'grey', minHeight: Scales.deviceHeight * 0.12, paddingTop: Scales.deviceHeight * 0.01, }}>
