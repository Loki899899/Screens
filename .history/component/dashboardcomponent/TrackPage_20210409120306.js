                        ...
                        <View>
                            <View style={{ width: Scales.deviceHeight * 0.08, justifyContent: "center", height: Scales.deviceHeight * 0.09, borderRadius: Scales.deviceHeight * 0.01, backgroundColor: this.state.image == "" ? "#ffa001" : "transparent", }}>
                                {this.state.image == "" ?
                                    ...
                                    <Image onError={() => { this.setState({ image: "" }) }} source={{ uri: this.props.data.pitcher.pitcher_url }} style={{ width: Scales.deviceHeight * 0.08, height: Scales.deviceHeight * 0.08, borderRadius: Scales.deviceHeight * 0.01}} />}
                            </View>
                            <View style={{
