                    ...
                    <View style={{flexDirection:'row'}}>
                        ...
                        <View style={{ alignItems: "center", flexDirection: "row", }}>
                             <Text style={{ fontFamily: "roboto-regular", fontSize: Scales.moderateScale(14), paddingLeft: 8, color: "white" }}>
                                <Text style={{ fontFamily: "roboto-bold", color: "white" }}>{this.props.data.pitcher.pitcher_fname} {this.props.data.pitcher.pitcher_lname}</Text> Invited for <Text style={{ fontFamily: "roboto-bold" }}>{this.props.data.job.job_title}  </Text>
                                {/* <Text>
