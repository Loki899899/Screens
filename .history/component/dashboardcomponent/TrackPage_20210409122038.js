                    ...
                    <View style={{flexDirection:'row'}}>
                        ...
                        <View style={{ backgroundColor: 'green', width: Scales.deviceWidth * 0.65 }}>
                            ...
                            <View style={{ flexDirection: "row", backgroundColor:'blue', padding:3, paddingLeft:7 }}>
                                <Image source={require("../../assets/JobmaIcons/video.png")} style={{ resizeMode: "contain", height: Scales.deviceHeight * 0.018, width: Scales.deviceWidth * 0.04, marginRight:3 }} />
