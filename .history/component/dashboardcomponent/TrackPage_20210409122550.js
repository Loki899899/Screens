                ...
                <View style={{ width: Scales.deviceWidth * 0.92, alignSelf: "center",  backgroundColor: "#3d3d46", elevation: 9, borderRadius: 5, padding: 5, paddingTop: 10, flexDirection: "row",shadowOffset: { width: 0, height: 1 },
                    ...
                    <View style={{flexDirection:'row'}}>
                        ...
                        <View style={{ backgroundColor: 'green', width: Scales.deviceWidth * 0.65 }}>
                            ...
                            <View style={{ flexDirection: "row", backgroundColor: 'blue', padding: 3, paddingLeft: 7, paddingBottom:0 }}>
                            ...
                            <View style={{ flexDirection: "row", backgroundColor: 'blue', padding: 3, paddingLeft: 7, paddingBottom:0 }}>
                                ...
                                <Text style={{ fontFamily: "roboto-medium", fontSize: Scales.moderateScale(10), }}>{this.props.data.interview_complete_notified_email}</Text>
                            </View>
                        </View>
                        {/* VIEW FOR 3 DOT MENU */}
                        <View></View>
