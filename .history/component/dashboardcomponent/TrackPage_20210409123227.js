            ...
            <View style={{ width: Scales.deviceWidth * 1.0,  justifyContent: "center", alignSelf: "center" }}>
                ...
                <View style={{ width: Scales.deviceWidth * 0.92, alignSelf: "center",  backgroundColor: "#3d3d46", elevation: 9, borderRadius: 5, padding: 5, paddingTop: 10, flexDirection: "row",shadowOffset: { width: 0, height: 1 },
                    ...
                    <View style={{flexDirection:'row'}}>
                        ...
                        <View>
                            <View style={{ width: Scales.deviceHeight * 0.08, justifyContent: "center", height: Scales.deviceHeight * 0.09, borderRadius: Scales.deviceHeight * 0.01, backgroundColor: this.state.image == "" ? "#ffa001" : "transparent", }}>
                                {this.state.image == "" ?
                                    ...
                                    <Image onError={() => { this.setState({ image: "" }) }} source={{ uri: this.props.data.pitcher.pitcher_url }} style={{ width: Scales.deviceHeight * 0.08, height: Scales.deviceHeight * 0.09, borderRadius: Scales.deviceHeight * 0.01}} />}
                            </View>
                            <View style={{
                        ...
                        <View style={{ backgroundColor: 'green', width: Scales.deviceWidth * 0.65 }}>
                            ...
                            <View style={{ flexDirection: "row", padding: 3, paddingLeft: 7, paddingBottom:0 }}>
                            <Image source={require("../../assets/JobmaIcons/video.png")} style={{ resizeMode: "contain", height: Scales.deviceHeight * 0.018, width: Scales.deviceWidth * 0.04, marginRight: 6 }} />
                                <Text style={{ fontFamily: "roboto-medium", fontSize: Scales.moderateScale(10), height: Scales.deviceHeight * 0.03, color: "#8b8b8b" }}>{this.props.data.jobma_interview_mode == 1 ? "Pre-recorded Interview" : this.props.data.jobma_interview_mode == 0 ? 'Offline Interview' : "Live Interview"}</Text>
                            </View>
                            <View style={{ flexDirection: "row", padding: 3, paddingLeft: 7, paddingBottom: 0 }}>
