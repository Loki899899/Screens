            ...
            <View style={{ width: Scales.deviceWidth * 1.0,  justifyContent: "center", alignSelf: "center" }}>
                ...
                <View style={{ width: Scales.deviceWidth * 0.92, alignSelf: "center",  backgroundColor: "#3d3d46", elevation: 9, borderRadius: 5, padding: 5, paddingTop: 10, flexDirection: "row",shadowOffset: { width: 0, height: 1 },
                    ...
                    <View style={{flexDirection:'row'}}>
                        ...
                        <View>
                            <View style={{ width: Scales.deviceHeight * 0.08, justifyContent: "center", height: Scales.deviceHeight * 0.08, borderRadius: Scales.deviceHeight * 0.008, backgroundColor: this.state.image == "" ? "#ffa001" : "transparent", }}>
                                {this.state.image == "" ?
                                    ...
                                    <Image onError={() => { this.setState({ image: "" }) }} source={{ uri: this.props.data.pitcher.pitcher_url }} style={{ width: Scales.deviceHeight * 0.08, height: Scales.deviceHeight * 0.08, borderRadius: Scales.deviceHeight * 0.008}} />}
                            </View>
                            <View style={{
