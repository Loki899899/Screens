                    ...
                    <View style={{ flexDirection: 'row' }}>
                        ...
                        <View style={{ backgroundColor: 'green', width: Scales.deviceWidth * 0.65 }}>
                            ...
                            <View style={{ flexDirection: "row", padding: 3, paddingLeft: 7, paddingBottom: 0 }}>
                                ...
                                <Text style={{ fontFamily: "roboto-medium", fontSize: Scales.moderateScale(10), color: "#8b8b8b" }}>{this.props.data.pitcher.pitcher_email}</Text>
                            </View>
                            <View style={{ flexDirection: "row", padding: 3, paddingLeft: 7, paddingBottom: 0 }}>
                                <Image source={require("../../assets/JobmaIcons/video.png")} style={{ resizeMode: "contain", height: Scales.deviceHeight * 0.018, width: Scales.deviceWidth * 0.04, marginRight: 6 }} />
                                <Text style={{ fontFamily: "roboto-medium", fontSize: Scales.moderateScale(10), color: "#8b8b8b" }}>{this.props.data.jobma_interview_mode == 1 ? "Pre-recorded Interview" : this.props.data.jobma_interview_mode == 0 ? 'Offline Interview' : "Live Interview"}</Text>
                            </View>
                            <View style={{ flexDirection: "row", padding: 3, paddingLeft: 7, paddingBottom: 0 }}>
                                ...
                                <Text style={{ fontFamily: "roboto-medium", fontSize: Scales.moderateScale(10), color: "#8b8b8b" }}>{moment(this.props.data.jobma_invitation_date).format(this.props.date_format)} - </Text>
                                <Text style={{ fontFamily: "roboto-medium", fontSize: Scales.moderateScale(10), color: "#8b8b8b" }}>{moment(this.props.data.jobma_invitation_expire_date).format(this.props.date_format)}</Text>
                            </View>
                        </View>
                        {/* VIEW FOR 3 DOT MENU */}
                        <View>
                        ...
                        <View style={{ borderRadius: 5, position: 'absolute', top: 0, right: 20, backgroundColor: '#52526c', width: Scales.deviceWidth * 0.3, zIndex: 100 }}
                            onTouchStart={(e) => {
                                e.stopPropagation()
                            }}
                        >
