            ...
            <SafeAreaView style={{ flex: 1 }}>
                <View style={{ flex: 1, backgroundColor: "#2c2c39" }} onTouchStart={() => {this.HideMenu()}}>
                    ...
                    <View style={{ width: Scales.deviceWidth * 1.0, }}>
                        ...
                        {this.state.jobs.length != 0 ? <View style={{ backgroundColor:'red',width: Scales.deviceWidth * 1.0, height: Scales.deviceHeight * 0.84, alignSelf: "center", }}>
                            <FlatList
        ...
        return (
            <View style={{ width: Scales.deviceWidth * 1.0, alignSelf: "center" }} >
                ...
                <Modal isVisible={this.state.send_reminder_modal} onBackButtonPress={() => this.setState({ send_reminder_modal: false, selected_date: this.props.data.jobma_invitation_expire_date })}>
                    <View style={{ width: Scales.deviceWidth * 1,flex: 1, justifyContent: "flex-end", backgroundColor:'blue' }}>
                <KeyboardDoneButton style={{flex:1, borderRadius: 10,}} />

                        <View style={{ width: Scales.deviceWidth * 1, height: Scales.deviceHeight * 0.50, backgroundColor: "#52526c", borderRadius: 10, marginTop:'5%' }}>
                            {/* CROSS ICON FOR MODAL */}
                            <View style={{ borderRadius: 10, alignItems:'flex-end', padding:'5%'}}>
                                <Image
