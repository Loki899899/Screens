...
class InterviewList extends Component {
    ...
    render() {
        ...
        return (
            <View style={{ width: Scales.deviceWidth * 1.0, alignSelf: "center", padding:6 }} >
                ...
                <Modal isVisible={this.state.send_reminder_modal} onBackButtonPress={() => this.setState({ send_reminder_modal: false, selected_date: this.props.data.jobma_invitation_expire_date })}>
                    <View style={{ width: Scales.deviceWidth * 1,flex: 1, justifyContent: "flex-end", backgroundColor:'blue', marginLeft:0, alignSelf:'flex-start' }}>
