        ...
        return (
            <View style={{ width: Scales.deviceWidth * 1.0, alignSelf: "center", }} >
                ...
                {/* <KeyboardDoneButton style={{flex:1, borderRadius: 10,}} /> */}
                        ...
                        <View style={{ width: Scales.deviceWidth * 1, height: Scales.deviceHeight * 0.50, backgroundColor: "#52526c", marginTop:'5%' }}>
                            {/* CROSS ICON FOR MODAL */}
                            <View style={{ borderRadius: 20, alignItems:'flex-end', padding:'5%'}}>
                                <Image
