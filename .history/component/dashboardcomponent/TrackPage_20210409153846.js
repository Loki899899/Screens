            ...
            <View style={{ width: Scales.deviceWidth * 1.0, alignSelf: "center", }} >
                ...
                {/* <KeyboardDoneButton style={{flex:1, borderRadius: 10,}} /> */}
                        ...
                        <View style={{ width: Scales.deviceWidth * 1, height: Scales.deviceHeight * 0.50, backgroundColor: "#52526c", borderRadius: 20, marginTop:'5%' }}>
                            ...
                            <Text style={{color:'white', fontSize:25, textAlign:'center'}}>SEND REMINDER</Text>
                            <View style={{ alignItems:'center', backgroundColor:'red'}}>
                                <TextInput placeholderTextColor='#3d3d46' placeholder='Message' style={{width:'90%', borderBottomWidth:1, borderBottomColor:'#52526c', padding:'5%', paddingBottom:0}}></TextInput>
                            </View>
