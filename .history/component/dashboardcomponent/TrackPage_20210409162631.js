            ...
            <SafeAreaView style={{ flex: 1 }}>
                <View style={{ flex: 1, backgroundColor: "#2c2c39", }} onTouchStart={() => {this.HideMenu()}}>
                    ...
                    <View style={{ width: Scales.deviceWidth * 1.0, }}>
                        ...
                        {this.state.jobs_show ? <View style={{ width: Scales.deviceWidth * 0.9, height: Scales.deviceHeight * 0.30, backgroundColor: "white", elevation: 9, borderRadius: 10, alignSelf: "center", }}>
