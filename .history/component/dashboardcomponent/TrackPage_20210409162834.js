            ...
            <SafeAreaView style={{ flex: 1 }}>
                <View style={{ flex: 1, backgroundColor: "#2c2c39", }} onTouchStart={() => {this.HideMenu()}}>
                    ...
                    <View style={{ width: Scales.deviceWidth * 1.0, }}>
                        ...
                        {this.state.jobs_show ? <View style={{ width: Scales.deviceWidth * 0.92, height: Scales.deviceHeight * 0.30, backgroundColor: "2d2d3a", elevation: 9, borderBottomLeftRadius: 10, borderBottomRightRadius:10, alignSelf: "center", }}>
