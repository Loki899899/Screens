            ...
            <SafeAreaView style={{ flex: 1 }}>
                <View style={{ flex: 1, backgroundColor: "#2c2c39", }} onTouchStart={() => {this.HideMenu()}}>
                    ...
                    <View style={{ width: Scales.deviceWidth * 1.0, }}>
                        <View style={{ backgroundColor:'red', width: Scales.deviceWidth * 1.0, height: Scales.deviceHeight * 0.07, flexDirection: "row", justifyContent: "center", alignItems:'flex-end'}}>
