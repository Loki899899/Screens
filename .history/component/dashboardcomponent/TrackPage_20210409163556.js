            ...
            <SafeAreaView style={{ flex: 1 }}>
                <View style={{ flex: 1, backgroundColor: "#2c2c39", }} onTouchStart={() => {this.HideMenu()}}>
                    ...
                    <View style={{ width: Scales.deviceWidth * 1.0, }}>
                        <View style={{ backgroundColor:'red', width: Scales.deviceWidth * 1.0, height: Scales.deviceHeight * 0.06, flexDirection: "row", justifyContent: "center", alignItems:'flex-end', paddingBottom:0}}>
                            <View style={{ width: Scales.deviceWidth * 0.8, height: Scales.deviceHeight * 0.06, borderRadius: 5, alignSelf: 'center' }}>
                                <TextInput onChangeText={(text) => this.searchJobFilterFunction(text)} value={this.state.seleted_job_name} style={{ backgroundColor: '#3d3d46', width: Scales.deviceWidth * 0.8, paddingLeft: Scales.deviceWidth * 0.06, fontFamily: "roboto-medium", height: Scales.deviceHeight * 0.06, borderRadius: 5, borderBottomRightRadius: 0, borderTopRightRadius: 0, borderRightWidth: 0, borderWidth: 0.5, fontSize: Scales.moderateScale(14), color: "white" }} />
                            ...
                            <View style={{ width: Scales.deviceWidth * 0.12, height: Scales.deviceHeight * 0.0595, justifyContent: "center", borderRadius: 5, borderWidth: 0.5, alignSelf: 'center', backgroundColor:'#52526c',borderLeftWidth: 0, borderTopLeftRadius: 0, borderBottomLeftRadius: 0 }}>
            ...
            <View style={{ width: Scales.deviceWidth * 1.0, alignSelf: "center", }} >
                ...
                <View style={{ width: Scales.deviceWidth * 0.92, alignSelf: "center",  backgroundColor: "#3d3d46", elevation: 9, borderRadius: 5, padding: 5, paddingTop: 10, flexDirection: "row",shadowOffset: { width: 0, height: 1 },
                    ...
                    <View style={{ flexDirection: 'row' }}>
                        ...
                        <View>
                            <View style={{ width: Scales.deviceHeight * 0.08, justifyContent: "center", height: Scales.deviceHeight * 0.08, borderRadius: Scales.deviceHeight * 0.0085, backgroundColor: this.state.image == "" ? "#ffa001" : "transparent", }}>
                                {this.state.image == "" ?
