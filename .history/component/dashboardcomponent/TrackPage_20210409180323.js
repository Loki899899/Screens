                    ...
                    <View style={{ flexDirection: 'row' }}>
                        ...
                        <View>
                            <View style={{ width: Scales.deviceHeight * 0.08, justifyContent: "center", height: Scales.deviceHeight * 0.08, borderRadius: Scales.deviceHeight * 0.0085, backgroundColor: this.state.image == "" ? "#2d2d3a" : "transparent", }}>
                                {this.state.image == "" ?
                                    <Text style={{ fontSize: Scales.moderateScale(18), textTransform: "capitalize", fontFamily: "roboto-medium", color: "white", alignSelf: "center" }}>{this.props.data.pitcher.pitcher_fname.slice(0, 2)}</Text> :
