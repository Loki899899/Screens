        ...
        return (
            ...
            <View style={{ flex: 1, flexDirection: 'column', backgroundColor: "#2d2d3a", }}>
                ...
                {this.state.show_search ? <View style={{ width: Scales.deviceWidth*0.90, marginTop: Scales.deviceHeight*0.013, marginBottom: Scales.deviceHeight*0.01, alignSelf: 'center', justifyContent: 'center', elevation: 5 }}>
                    <TextInput placeholderTextColor = {"#c7c7c7"}  style={{ width: Scales.deviceWidth*0.90, height: Scales.deviceHeight * 0.06,color:"#3c3c3c", backgroundColor: '#3d3d46', borderRadius: 5, textAlign: 'left', fontFamily: 'roboto-regular', borderWidth: 1, alignSelf: 'center', paddingLeft:Scales.deviceWidth*0.03,fontSize:Scales.moderateScale(14)}} placeholder="Enter text" value ={this.state.search_text} onChangeText={(text) => this.searchFilterFunction(text)} />
                </View> : null}
