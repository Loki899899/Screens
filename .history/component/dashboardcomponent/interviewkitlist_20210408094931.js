...
export default class KitList extends Component {
    ...
    render() {
        ...
        return (
            <React.Fragment>
                <View style={{ padding: Scales.deviceWidth*0.03, backgroundColor: 'white', marginTop: 10, flexDirection: 'column', width: Scales.deviceWidth * 0.95, alignSelf: 'center', borderRadius: 5, elevation: 5,shadowOffset: { width: 0, height: 1 },
                                                            shadowOpacity: 0.1,
                                                            shadowRadius: 1  }}>
