...
export default class KitList extends Component {
    ...
    render() {
        ...
        return (
            <React.Fragment>
                <View style={{ padding: Scales.deviceWidth*0.03, backgroundColor: '3d3d46', marginTop: 10, flexDirection: 'column', width: Scales.deviceWidth * 0.95, alignSelf: 'center', borderRadius: 5, elevation: 5,shadowOffset: { width: 0, height: 1 },
                                                            shadowOpacity: 0.1,
                                                            shadowRadius: 1  }}>
                    <View style={{ flexBasis: 25, width: Scales.deviceWidth * 0.90,  flexDirection: 'row', opacity: this.value==true ? 1 : 0.3 }}>
                        <Text style={{ fontFamily: 'roboto-medium', width: Scales.deviceWidth * 0.40, textTransform: "capitalize",color:"#3c3c3c",fontSize:Scales.moderateScale(13) }}>{this.props.data.title}</Text>
                        <View style={{ height: Scales.deviceHeight * 0.03, width: Scales.deviceWidth * 0.48, alignItems: 'flex-end', }}>
                            <ToggleSwitch
                                isOn={this.value}
                                onColor="#13d7a6"
                                offColor="#9d9d9d"
                    ...
                    <View style={{ height: Scales.deviceHeight * 0.04, width: Scales.deviceWidth * 0.85, flexDirection: 'row', paddingTop: Scales.deviceHeight*0.006, opacity: this.value==true ? 1 : 0.3 }}>
                        <View style={{ height: Scales.deviceHeight * 0.025, width: Scales.deviceWidth * 0.34, justifyContent: 'center' }}>
                            <Text style={{ fontSize: Scales.moderateScale(12), fontFamily: "roboto-regular",color:"#3c3c3c"}}>Created: {moment(this.props.data.created_at).format(this.props.date_format)}</Text>
                        </View>
                        <View style={{ height: Scales.deviceHeight * 0.025, width: Scales.deviceWidth * 0.34, justifyContent: 'center', marginLeft: Scales.deviceWidth * 0.01 }}>
                            <Text style={{ height: Scales.deviceHeight * 0.025, fontSize: Scales.moderateScale(12), fontFamily: "roboto-regular",color:"#3c3c3c" }}>Updated: {expiry_date}</Text>
                    ...
                    <View style={{ height: Scales.deviceHeight * 0.02, width: Scales.deviceWidth * 0.80, flexDirection: 'row', opacity: this.value==true ? 1 : 0.3 }}>
                        <View style={{ height: Scales.deviceHeight * 0.02, width: Scales.deviceWidth*0.90, justifyContent: 'center' }}>
                            <Text style={{ fontSize: Scales.moderateScale(12), height: Scales.deviceHeight * 0.025, fontFamily: "roboto-regular",color:"#3c3c3c" }}>Created by: {this.props.data.catcher_name}</Text>
                        </View>
                    ...
                    <View style={{ flexDirection: 'row', height: Scales.deviceHeight * 0.04, width: Scales.deviceWidth * 0.85, backgroundColor: '#f6f6f6', flexDirection: 'row', marginTop: Scales.deviceHeight * 0.015, alignItems: "center", borderRadius: 5, opacity: this.value==true ? 1 : 0.3 }}>
