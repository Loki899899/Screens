...
export default class KitList extends Component {
    ...
    render() {
        ...
        return (
            <React.Fragment>
                <View style={{ padding: Scales.deviceWidth*0.03, backgroundColor: 'green', marginTop: 10, flexDirection: 'column', width: Scales.deviceWidth * 0.95, alignSelf: 'center', borderRadius: 5,}}>
