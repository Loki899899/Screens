                ...
                <View style={{ padding: Scales.deviceWidth*0.03, backgroundColor: '#3d3d46', marginTop: 10, flexDirection: 'column', width: Scales.deviceWidth * 0.95, alignSelf: 'center', borderRadius: 5,}}>
                    ...
                    <View style={{ height: Scales.deviceHeight * 0.04, width: Scales.deviceWidth * 0.85, flexDirection: 'row', paddingTop: Scales.deviceHeight*0.006, opacity: this.value==true ? 1 : 0.3 }}>
                        <View style={{ height: Scales.deviceHeight * 0.025, width: Scales.deviceWidth * 0.34, justifyContent: 'center' }}>
                            <Text style={{ fontSize: Scales.moderateScale(12), fontFamily: "roboto-regular",color:"white"}}>Created: {moment(this.props.data.created_at).format(this.props.date_format)}</Text>
                        </View>
