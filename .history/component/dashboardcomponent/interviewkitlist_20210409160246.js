            ...
            <React.Fragment>
                <View style={{ padding: Scales.deviceWidth*0.03, backgroundColor: '#3d3d46', marginTop: 10, flexDirection: 'column', width: Scales.deviceWidth * 0.95, alignSelf: 'center', borderRadius: 5,}}>
                    <View style={{ flexBasis: 25, width: Scales.deviceWidth * 0.90,  flexDirection: 'row', opacity: this.value==true ? 1 : 0.3 }}>
                        <Text style={{ fontFamily: 'roboto-medium', width: Scales.deviceWidth * 0.40, textTransform: "capitalize",color:"white",fontSize:Scales.moderateScale(13) }}>{this.props.data.title}</Text>
