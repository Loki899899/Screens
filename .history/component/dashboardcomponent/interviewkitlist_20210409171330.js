        ...
        return (
            <React.Fragment>
                <View style={{ backgroundColor: '#3d3d46', marginTop: 10, flexDirection: 'column', width: Scales.deviceWidth * 0.95, alignSelf: 'center', borderRadius: 5,}}>
                    ...
                    <View style={{ flexDirection: 'row', height: Scales.deviceHeight * 0.04, width: Scales.deviceWidth * 0.95, backgroundColor: 'blue', flexDirection: 'row', marginTop: Scales.deviceHeight * 0.015, alignItems: "center", borderBottomRightRadius: 5, borderBottomLeftRadius:5, opacity: this.value == true ? 1 : 0.3 }}>
