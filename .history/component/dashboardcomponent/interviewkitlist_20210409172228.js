                ...
                <View style={{ backgroundColor: '#3d3d46', marginTop: 10, flexDirection: 'column', width: Scales.deviceWidth * 0.95, alignSelf: 'center', borderRadius: 5,}}>
                    ...
                    <View style={{ flexDirection: 'row', height: Scales.deviceHeight * 0.04, width: Scales.deviceWidth * 0.95, backgroundColor: '#52526c', flexDirection: 'row', marginTop: Scales.deviceHeight * 0.015, alignItems: "center", borderBottomRightRadius: 5, borderBottomLeftRadius:5, opacity: this.value == true ? 1 : 0.3 }}>
                        <View style={{ width: Scales.deviceWidth * 0.90, height: Scales.deviceHeight * 0.04, flexDirection: 'row', }}>
                            ...
                            <View style={{  height: Scales.deviceHeight * 0.04, flexDirection: 'row', marginRight:'6%' }}>
                                ...
                                <View style={{ width: Scales.deviceWidth * 0.045, height: Scales.deviceHeight * 0.04, justifyContent: 'center', paddingLeft: Scales.deviceWidth * 0.012 }}>
                                    <Image source={require('../../assets/Images/white_essay.png')} style={{ resizeMode: 'contain', width: Scales.deviceWidth * 0.05, height: Scales.deviceHeight * 0.02, }} />
                                </View>
                                <View style={{ width: Scales.deviceWidth * 0.08, height: Scales.deviceHeight * 0.04, justifyContent: 'center', }}>
                                    <Text style={{ textAlign: 'center', fontFamily: 'roboto-regular', color: "#8b8b8b", fontSize: Scales.moderateScale(14) }} >{this.props.data.essay}</Text>
                                </View>
                            ...
                            <View style={{ height: Scales.deviceHeight * 0.04, flexDirection: 'row', marginRight:'5%' }}>
                                ...
                                <View style={{ width: Scales.deviceWidth * 0.08, height: Scales.deviceHeight * 0.04, justifyContent: 'center', }}>
                                    <Text style={{ textAlign: 'center', fontFamily: 'roboto-regular', color: "#8b8b8b", fontSize: Scales.moderateScale(14) }} >{this.props.data.slide}</Text>
                                </View>
                                {/* <View style={{ borderRightWidth: 1, height: Scales.deviceHeight * 0.03, borderColor: "#c8c8c8", alignSelf: 'center', paddingLeft: Scales.deviceWidth * 0.012 }}></View> */}
                            ...
                            <View style={{ width: "20%", height: Scales.deviceHeight * 0.04, flexDirection: 'row', marginRight:0}}>

                                <View style={{ width: Scales.deviceWidth * 0.045, height: Scales.deviceHeight * 0.04, justifyContent: 'center', paddingLeft: Scales.deviceWidth * 0.012 }}>
                                    <Image source={require('../../assets/Images/white_mcq.png')} style={{ resizeMode: 'contain', width: Scales.deviceWidth * 0.05, height: Scales.deviceHeight * 0.02, }} />
                                </View>
                                <View style={{ width: Scales.deviceWidth * 0.08, height: Scales.deviceHeight * 0.04, justifyContent: 'center', marginLeft:'2%' }}>
                                    <Text style={{ textAlign: 'center', fontFamily: 'roboto-regular', color: "#8b8b8b", fontSize: Scales.moderateScale(14) }} >{this.props.data.mcq}</Text>
                                </View>
                                {/* <View style={{ borderRightWidth: 1, height: Scales.deviceHeight * 0.03, borderColor: "#c8c8c8", alignSelf: 'center', paddingLeft: Scales.deviceWidth * 0.012 }}></View> */}
                            ...
                            <View style={{ width: "20%", height: Scales.deviceHeight * 0.04, flexDirection: 'row', marginRight:'1%' }}>

                                <View style={{ width: Scales.deviceWidth * 0.045, height: Scales.deviceHeight * 0.04, justifyContent: 'center', paddingLeft: Scales.deviceWidth * 0.012 }}>
                                    <Image source={require('../../assets/Images/white_video.png')} style={{ resizeMode: 'contain', width: Scales.deviceWidth * 0.05, height: Scales.deviceHeight * 0.02, }} />
                                </View>
                                <View style={{ width: Scales.deviceWidth * 0.08, height: Scales.deviceHeight * 0.04, justifyContent: 'center', marginLeft:'4%'}}>
                                    <Text style={{ textAlign: 'center', fontFamily: 'roboto-regular', color: "#8b8b8b", fontSize: Scales.moderateScale(14) }} >{this.props.data.video}</Text>
                                </View>
                            ...
                            <View style={{ width: "20%", height: Scales.deviceHeight * 0.04, flexDirection: 'row' }}>
                                ...
                                <View style={{ width: Scales.deviceWidth * 0.08, height: Scales.deviceHeight * 0.04, justifyContent: 'center', }}>
                                    <Text style={{ textAlign: 'center', fontFamily: 'roboto-regular', color: "#8b8b8b", fontSize: Scales.moderateScale(14) }} >{this.props.data.audio}</Text>
                                </View>
