    ...
    render() {
        ...
        return (<React.Fragment>
            <View key={this.props} style={{ flex: 1, flexDirection: 'column', marginTop: 10, }}>
                <View style={{
                    width: Scales.deviceWidth * 0.95, minHeight: Scales.deviceHeight * 0.25, alignSelf: 'center', backgroundColor: '#ffffff', elevation: 9, borderRadius: 10, shadowColor: '#000',
                    ...
                    <View style={{ width: Scales.deviceWidth * 0.95, paddingTop: Scales.deviceHeight * 0.01, paddingLeft: Scales.deviceWidth * 0.028, flexDirection: 'row', opacity: opaci == true ? 1 : 0.3, }}>
                        <View style={{ width: Scales.deviceWidth * 0.775, flexDirection: 'row' }}>
                            <Text style={{ fontSize: Scales.moderateScale(18), fontFamily: 'roboto-medium', textTransform: "capitalize", color: "#3c3c3c" }}>{this.props.data.job_title}</Text>{expired ? <Text style={{ fontFamily: "roboto-regular", textAlignVertical: "top", color: 'red', fontSize: Scales.moderateScale(8) }}>(Expired)</Text> : null}
                        </View>
                        <View style={{ width: Scales.deviceWidth * 0.10, alignItems: "center" }}>
                            <ToggleSwitch
                                isOn={value}
                                onColor={expired ? "#9d9d9d" : "#564db3"}
                                offColor="#9d9d9d"
                    ...
                    <View style={{ width: Scales.deviceWidth * 0.95, minHeight: Scales.deviceHeight * 0.04, flexDirection: 'row', opacity: opaci == true ? 1 : 0.3, paddingLeft: Scales.deviceHeight * 0.01 }}>
                        <View style={{ width: Scales.deviceWidth * 0.75, flexDirection: 'row', alignItems: 'center', padding: Scales.deviceWidth * 0.015 }}>
                            ...
                            <Text style={{ fontFamily: 'roboto-regular', fontSize: Scales.moderateScale(12), left: Scales.deviceWidth * 0.015, color: "#3c3c3c" }}>Recruiter name: <Text style={{ fontFamily: 'roboto-medium', }}>{this.props.data.catcher.fname} {this.props.data.catcher.lname}</Text></Text>
                        </View>
                    ...
                    <View style={{ width: Scales.deviceWidth * 0.95, height: Scales.deviceHeight * 0.04, flexDirection: 'row', alignItems: 'center', padding: Scales.deviceWidth * 0.002, opacity: opaci == true ? 1 : 0.3, paddingLeft: Scales.deviceWidth * 0.03 }}>
                        ...
                        <Text style={{ fontFamily: 'roboto-regular', fontSize: Scales.moderateScale(12), left: Scales.deviceWidth * 0.015, color: "#3c3c3c" }}>Posted on: <Text style={{ fontFamily: 'roboto-regular', fontSize: Scales.moderateScale(12), left: Scales.deviceWidth * 0.015 }}>{posted_date} </Text> </Text>
                        <Text style={{ fontFamily: 'roboto-regular', fontSize: Scales.moderateScale(12), left: Scales.deviceWidth * 0.015, color: "#3c3c3c" }}>Expiry date: <Text style={{ fontFamily: 'roboto-regular', fontSize: Scales.moderateScale(12), left: Scales.deviceWidth * 0.015 }}>{expired_date}</Text> </Text>


                    </View>

                    <View style={{ width: Scales.deviceWidth * 0.95, height: Scales.deviceHeight * 0.04, flexDirection: 'row', alignItems: 'center', opacity: opaci == true ? 1 : 0.3, paddingLeft: Scales.deviceWidth * 0.03 }}>
                        ...
                        <Text style={{ fontFamily: 'roboto-regular', fontSize: Scales.moderateScale(12), left: Scales.deviceWidth * 0.015, color: "#3c3c3c" }}>Job approval</Text>
                    ...
                    <View style={{ width: Scales.deviceWidth * 0.95, height: Scales.deviceHeight * 0.08, flexDirection: 'row', paddingLeft: 2, justifyContent: 'space-evenly', paddingTop: Scales.deviceWidth * 0.015, marginTop: Scales.deviceWidth * 0.015, opacity: opaci == true ? 1 : 0.3, }}>
                        <View style={{ width: Scales.deviceWidth * 0.18, height: Scales.deviceHeight * 0.06, backgroundColor: '#fff2bc', borderRadius: 5 }}>
                        ...
                        <View style={{ width: Scales.deviceWidth * 0.18, height: Scales.deviceHeight * 0.06, backgroundColor: '#def3ff', borderRadius: 5 }}>
                            <Text style={{ fontSize: Scales.moderateScale(10), fontFamily: 'roboto-medium', textAlign: 'center', paddingTop: Scales.deviceWidth * 0.015, color: "#6eaff1" }}>INVITED</Text>
                            <Text style={{ fontSize: Scales.moderateScale(14), fontFamily: 'roboto-medium', textAlign: 'center', color: "#3c3c3c" }}>{this.props.data.invited}</Text>

                        </View>

                        <View style={{ width: Scales.deviceWidth * 0.18, height: Scales.deviceHeight * 0.06, backgroundColor: '#e1f7ee', borderRadius: 5, }}>
                        ...
                        <View style={{ width: Scales.deviceWidth * 0.18, height: Scales.deviceHeight * 0.06, backgroundColor: '#cdffbc', borderRadius: 5 }}>
                        ...
                        <View style={{ width: Scales.deviceWidth * 0.17, height: Scales.deviceHeight * 0.06, backgroundColor: '#ffdcda', borderRadius: 5, }}>
