                ...
                <View style={{
                    ...
                    <View style={{ width: Scales.deviceWidth * 0.95, paddingTop: Scales.deviceHeight * 0.01, paddingLeft: Scales.deviceWidth * 0.028, flexDirection: 'row', opacity: opaci == true ? 1 : 0.3, }}>
                        <View style={{ width: Scales.deviceWidth * 0.775, flexDirection: 'row' }}>
                            <Text style={{ fontSize: Scales.moderateScale(18), fontFamily: 'roboto-medium', textTransform: "capitalize", color: "#2c2c39" }}>{this.props.data.job_title}</Text>{expired ? <Text style={{ fontFamily: "roboto-regular", textAlignVertical: "top", color: 'red', fontSize: Scales.moderateScale(8) }}>(Expired)</Text> : null}
                        </View>
