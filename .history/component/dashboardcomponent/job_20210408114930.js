        ...
        return (<React.Fragment>
            <View key={this.props} style={{ flex: 1, flexDirection: 'column', marginTop: 10, }}>
                <View style={{
                    ...
                    <View style={{ width: Scales.deviceWidth * 0.95,  flexDirection: 'row', paddingLeft: 2, justifyContent: 'space-evenly', paddingTop: Scales.deviceWidth * 0.015, marginTop: Scales.deviceWidth * 0.015, opacity: opaci == true ? 1 : 0.3, }}>
