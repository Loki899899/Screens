            ...
            <View key={this.props} style={{ flex: 1, flexDirection: 'column', marginTop: 10, }}>
                <View style={{
                    ...
                    <View style={{flexDirection: 'row', paddingLeft: 2, justifyContent: 'space-evenly',opacity: opaci == true ? 1 : 0.3, }}>
                        ...
                        <View style={{ backgroundColor: '#52526c', borderRadius: 10, flexDirection:'row', padding:2 }}>
                            ...
                            <Text style={{ fontSize: Scales.moderateScale(10), fontFamily: 'roboto-medium', textAlign: 'center', color: "#6eaff1" }}>APPLICANTS</Text>

                        </View>

                        <View style={{ backgroundColor: '#52526c', borderRadius: 5, flexDirection:'row' }}>
                            <Text style={{ fontSize: Scales.moderateScale(14), fontFamily: 'roboto-medium', textAlign: 'center', color: "#3c3c3c", borderRadius:5, backgroundColor:'#ffffff', padding:0 }}>{this.props.data.invited}</Text>
