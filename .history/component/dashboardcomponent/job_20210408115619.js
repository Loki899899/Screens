                ...
                <View style={{
                    ...
                    <View style={{flexDirection: 'row', paddingLeft: 2, justifyContent: 'space-evenly',opacity: opaci == true ? 1 : 0.3, }}>
                        ...
                        <View style={{ backgroundColor: '#52526c', borderRadius: 10, flexDirection:'row', paddingLeft:4, paddingRight:4 }}>
                            <Text style={{ fontSize: Scales.moderateScale(14), fontFamily: 'roboto-medium', textAlign: 'center', color: "#3c3c3c", borderRadius:5, backgroundColor:'#ffffff' }}>{this.props.data.applicants}</Text>
