        ...
        return (<React.Fragment>
            <View key={this.props} style={{ flex: 1, flexDirection: 'column', marginTop: 10, }}>
                <View style={{
                    ...
                    <View style={{flexDirection: 'row', paddingLeft: 2, justifyContent: 'space-evenly',opacity: opaci == true ? 1 : 0.3, }}>
                        ...
                        <View style={{ backgroundColor: '#52526c', borderRadius: 10, flexDirection:'row', padding:4}}>
                            <View style={{ backgroundColor:'#ffffff' , height:Scales.deviceHeight * 0.018, width:Scales.deviceWidth * 0.032, justifyContent:'center', borderRadius:5, paddingBottom:1}}>
                            <Text style={{ fontSize: Scales.moderateScale(14), fontFamily: 'roboto-medium', textAlign: 'center', color: "#3c3c3c", borderRadius:5,  }}>{this.props.data.applicants}</Text>
                            </View>
                            <Text style={{ fontSize: Scales.moderateScale(10), fontFamily: 'roboto-medium', textAlign: 'center', color: "#ffffff" }}>APPLICANTS</Text>

                        </View>

                        <View style={{ backgroundColor: '#52526c', borderRadius: 5, flexDirection:'row' }}>
                            <Text style={{ fontSize: Scales.moderateScale(14), fontFamily: 'roboto-medium', textAlign: 'center', color: "#3c3c3c", borderRadius:5, backgroundColor:'#ffffff', }}>{this.props.data.invited}</Text>
                            <Text style={{ fontSize: Scales.moderateScale(10), fontFamily: 'roboto-medium', textAlign: 'center', color: "#6eaff1" }}>INVITED</Text>

                        </View>

                        <View style={{ backgroundColor: '#52526c', borderRadius: 5, flexDirection:'row' }}>
                            <Text style={{ fontSize: Scales.moderateScale(14), fontFamily: 'roboto-medium', textAlign: 'center', color: "#3c3c3c", borderRadius:5, backgroundColor:'#ffffff' }}>{this.props.data.selected}</Text>
                            <Text style={{ fontSize: Scales.moderateScale(10), fontFamily: 'roboto-medium', textAlign: 'center', color: "#6eaff1" }}>SELECTED</Text>

                        </View>

                        <View style={{ backgroundColor: '#52526c', borderRadius: 5, flexDirection:'row' }}>
                            <Text style={{ fontSize: Scales.moderateScale(14), fontFamily: 'roboto-medium', textAlign: 'center', color: "#3c3c3c", borderRadius:5, backgroundColor:'#ffffff' }}>{this.props.data.hold}</Text>
                            <Text style={{ fontSize: Scales.moderateScale(10), fontFamily: 'roboto-medium', textAlign: 'center', color: "#6eaff1" }}>ON HOLD</Text>

                        </View>

                        <View style={{ backgroundColor: '#52526c', borderRadius: 5, flexDirection:'row' }}>
                            <Text style={{ fontSize: Scales.moderateScale(14), fontFamily: 'roboto-medium', textAlign: 'center', color: "#3c3c3c", borderRadius:5, backgroundColor:'#ffffff' }}>{this.props.data.rejected}</Text>
                            <Text style={{ fontSize: Scales.moderateScale(10), fontFamily: 'roboto-medium', textAlign: 'center', color: "#6eaff1" }}>REJECTED</Text>
