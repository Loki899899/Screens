        ...
        return (<React.Fragment>
            <View key={this.props} style={{ flex: 1, flexDirection: 'column', marginTop: 10, }}>
                <View style={{
                    ...
                    <View style={{flexDirection: 'row', paddingLeft: '4%', opacity: opaci == true ? 1 : 0.3, }}>
                        ...
                        <View style={{ backgroundColor: '#52526c', borderRadius: 10, flexDirection:'row', padding:4, marginLeft:2}}>
                        ...
                        <View style={{ backgroundColor: '#52526c', borderRadius: 10, flexDirection:'row', padding:4}}>
                            <View style={{ backgroundColor:'#ffffff' , height:Scales.deviceHeight * 0.018, width:Scales.deviceWidth * 0.032, justifyContent:'center', borderRadius:5,}}>
                            <Text style={{ fontSize: Scales.moderateScale(14), fontFamily: 'roboto-medium', textAlign: 'center', color: "#3c3c3c", borderRadius:5,  }}>{this.props.data.invited}</Text>
                            </View>
                        ...
                        <View style={{ backgroundColor: '#52526c', borderRadius: 10, flexDirection:'row', padding:4}}>
                            <View style={{ backgroundColor:'#ffffff' , height:Scales.deviceHeight * 0.018, width:Scales.deviceWidth * 0.032, justifyContent:'center', borderRadius:5,}}>
                            <Text style={{ fontSize: Scales.moderateScale(14), fontFamily: 'roboto-medium', textAlign: 'center', color: "#3c3c3c", borderRadius:5,  }}>{this.props.data.selected}</Text>
                            </View>
                        ...
                        <View style={{ backgroundColor: '#52526c', borderRadius: 10, flexDirection:'row', padding:4}}>
                            <View style={{ backgroundColor:'#ffffff' , height:Scales.deviceHeight * 0.018, width:Scales.deviceWidth * 0.032, justifyContent:'center', borderRadius:5,}}>
                            <Text style={{ fontSize: Scales.moderateScale(14), fontFamily: 'roboto-medium', textAlign: 'center', color: "#3c3c3c", borderRadius:5,  }}>{this.props.data.hold}</Text>
                            </View>
                        ...
                        <View style={{ backgroundColor: '#52526c', borderRadius: 10, flexDirection:'row', padding:4}}>
                            <View style={{ backgroundColor:'#ffffff' , height:Scales.deviceHeight * 0.018, width:Scales.deviceWidth * 0.032, justifyContent:'center', borderRadius:5,}}>
                            <Text style={{ fontSize: Scales.moderateScale(14), fontFamily: 'roboto-medium', textAlign: 'center', color: "#3c3c3c", borderRadius:5,  }}>{this.props.data.rejected}</Text>
                            </View>
