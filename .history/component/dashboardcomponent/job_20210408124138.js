    ...
    render() {
        ...
        return (<React.Fragment>
            <View key={this.props} style={{ flex: 1, flexDirection: 'column', marginTop: 10, }}>
                <View style={{
                    width: Scales.deviceWidth * 0.95, minHeight: Scales.deviceHeight * 0.21, alignSelf: 'center', backgroundColor: '#3d3d46', elevation: 9, borderRadius: 10, shadowColor: '#000',
                    ...
                    <View style={{ width: Scales.deviceWidth * 0.95, height: Scales.deviceHeight * 0.04, flexDirection: 'row', alignItems: 'center', padding: Scales.deviceWidth * 0.002, opacity: opaci == true ? 1 : 0.3, paddingLeft: Scales.deviceWidth * 0.03 }}>
                        ...
                        <Text style={{ fontFamily: 'roboto-regular', fontSize: Scales.moderateScale(10), left: Scales.deviceWidth * 0.015, color: "#8b8b8b" }}>Posted on: <Text style={{ fontFamily: 'roboto-regular', fontSize: Scales.moderateScale(12), left: Scales.deviceWidth * 0.015 }}>{posted_date} </Text> </Text>
