        ...
        return (<React.Fragment>
            <View key={this.props} style={{ flex: 1, flexDirection: 'column', marginTop: 10, }}>
                <View style={{
                    ...
                    <View style={{ width: Scales.deviceWidth * 0.95, height: Scales.deviceHeight * 0.03, flexDirection: 'row', opacity: opaci == true ? 1 : 0.3, paddingLeft: Scales.deviceHeight * 0.01 }}>
                    ...
                    <View style={{backgroundColor:'blue', width: Scales.deviceWidth * 0.95, height: Scales.deviceHeight * 0.03, flexDirection: 'row', alignItems: 'center', opacity: opaci == true ? 1 : 0.3, paddingLeft: Scales.deviceWidth * 0.03 }}>
