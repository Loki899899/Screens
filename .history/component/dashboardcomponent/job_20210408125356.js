        ...
        return (<React.Fragment>
            <View key={this.props} style={{ flex: 1, flexDirection: 'column', marginTop: 10, }}>
                <View style={{
                    ...
                    <View style={{ width: Scales.deviceWidth * 0.95, minHeight: Scales.deviceHeight * 0.04, flexDirection: 'row', opacity: opaci == true ? 1 : 0.3, paddingLeft: Scales.deviceHeight * 0.012, alignItems:'flex-end' }}>
