            ...
            <View key={this.props} style={{ flex: 1, flexDirection: 'column', marginTop: 10, }}>
                <View style={{
                    ...
                    <View style={{ width: Scales.deviceWidth * 0.95, height: Scales.deviceHeight * 0.03, flexDirection: 'row', alignItems: 'center', opacity: opaci == true ? 1 : 0.3, paddingLeft: Scales.deviceWidth * 0.03, marginBottom: Scales.deviceHeight * 0.005 }}>
                        ...
                        {this.props.data.approval == "1" ? <Image source={require('../../assets/JobmaIcons/job-approval.png')} style={{ resizeMode: 'contain', width: Scales.deviceWidth * 0.04, height: Scales.deviceHeight * 0.03, left: Scales.deviceWidth * 0.065 }} /> : null}
