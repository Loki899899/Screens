            ...
            <View key={this.props} style={{ flex: 1, flexDirection: 'column', marginTop: 10, }}>
                <View style={{
                    ...
                    <View style={{ width: Scales.deviceWidth * 0.90, paddingTop: Scales.deviceHeight * 0.01, paddingLeft: Scales.deviceWidth * 0.028, flexDirection: 'row', opacity: opaci == true ? 1 : 0.3, }}>
                        <View style={{ width: Scales.deviceWidth * 0.72, flexDirection: 'row', backgroundColor:'green' }}>
                        ...
                        <View style={{ backgroundColor:'red',width: Scales.deviceWidth * 0.18, alignItems: "center", justifyContent:'space-between', flexDirection:'row',}}>
                            <ToggleSwitch
