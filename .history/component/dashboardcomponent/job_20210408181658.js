        ...
        return (<React.Fragment>
            <View key={this.props} style={{ flex: 1, flexDirection: 'column', marginTop: 10, }}>
                <View style={{
                    ...
                    <View style={{ width: Scales.deviceWidth * 0.90, paddingTop: Scales.deviceHeight * 0.01, paddingLeft: Scales.deviceWidth * 0.028, flexDirection: 'row', opacity: opaci == true ? 1 : 0.3, }}>
                        ...
                        <View style={{ width: Scales.deviceWidth * 0.17, alignItems: "center", justifyContent:'space-between', flexDirection:'row',}}>
                            ...
                            <View style={{display:this.state.dotmenu, position:'absolute', top:5, left:-200, backgroundColor:'#52526c',}}>
                                <Text>Renew Job</Text>
                                <Text>Track</Text>
                                <Text>Evaluate</Text>
                            </View>
