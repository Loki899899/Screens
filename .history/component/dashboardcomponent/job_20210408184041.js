                ...
                <View 
                    ...
                    >
                        ...
                        <View style={{ width: Scales.deviceWidth * 0.17, alignItems: "center", justifyContent:'space-between', flexDirection:'row',}}>
                            ...
                            <View style={{ position:'absolute', top:0, left:-40, backgroundColor:'#52526c', width:Scales.deviceWidth*0.23, zIndex:100}}
                                // onStartShouldSetResponder={(e) => {
                                //     e.stopPropagation()
                                // }}
                            >
                            <View style={{display:this.state.dotmenu, padding:'5%', borderRadius:5}}>
