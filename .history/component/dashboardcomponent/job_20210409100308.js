                        ...
                        <View style={{ width: Scales.deviceWidth * 0.17, alignItems: "center", justifyContent:'space-between', flexDirection:'row',}}>
                            ...
                            >
                                <View style={{ display: this.state.dotmenu, paddingTop: '1%', paddingBottom:'1%'}}>
                                    <TouchableOpacity>
                                        <Text style={{ fontSize: 16,padding:'3%' }}>Renew Job</Text>
                                    </TouchableOpacity>
                                    <TouchableOpacity>
                                        <Text style={{ fontSize: 16, borderTopWidth: 0.25, borderBottomWidth: 0.25, padding:'3%'}}>Track</Text>
                                    </TouchableOpacity>
                                    <TouchableOpacity>
                                        <Text style={{ fontSize: 16,padding:'3%' }}>Evaluate</Text>
                                    </TouchableOpacity>
                                </View>
                            </View>
                        </View>
