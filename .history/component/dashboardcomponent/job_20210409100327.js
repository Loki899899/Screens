...
export default class Jobs extends Component {
    ...
    render() {
        ...
        return (<React.Fragment>
            <View key={this.props} style={{ flex: 1, flexDirection: 'column', marginTop: 10, zIndex:0}}
                ...
                <View 
                    ...
                    >
                        ...
                        <View style={{ width: Scales.deviceWidth * 0.17, alignItems: "center", justifyContent:'space-between', flexDirection:'row',}}>
                            ...
                            <View style={{ borderRadius:5, position:'absolute', top:0, left:-40, backgroundColor:'#52526c', width:Scales.deviceWidth*0.23, zIndex:100}}
