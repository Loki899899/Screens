...
export default class Jobs extends Component {
    ...
    render() {
        console.log(this.props.data.job_id)
                            ...
                            >
                                <View style={{ display: this.state.dotmenu, paddingTop: '1%', paddingBottom:'1%'}}>
                                    <TouchableOpacity onPress={this.Renew_job}>
                                        <Text style={{ fontSize: 16,padding:'5%' }}>Renew Job</Text>
                                    </TouchableOpacity>
                                    <TouchableOpacity onPress={this.Click_Track}>
                                        <Text style={{ fontSize: 16, borderTopWidth: 0.25, borderBottomWidth: 0.25, padding:'5%'}}>Track</Text>
                                    </TouchableOpacity>
                                    <TouchableOpacity onPress={this.Click_Evaluate}>
                                        <Text style={{ fontSize: 16,padding:'5%' }}>Evaluate</Text>
                                    </TouchableOpacity>
                                </View>
                            </View>
