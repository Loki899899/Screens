                    ...
                    <View style={{ borderRadius:5, position:'absolute', top:5, right:25, backgroundColor:'#52526c', width:Scales.deviceWidth*0.3, zIndex:100}}
                            ...
                            >
                                <View style={{ display: this.state.dotmenu, paddingTop: '1%', paddingBottom:'1%'}}>
                                    <TouchableOpacity onPress={this.Renew_job} style={{paddingLeft:Scales.deviceWidth * 0.005, paddingRight:Scales.deviceWidth * 0.005,}}>
                                        <Text style={{ color:'white', fontSize: 16,padding:'5%', textAlign:'center' }}>Renew Job</Text>
                                    </TouchableOpacity>
                                    <TouchableOpacity onPress={this.Click_Track} style={{ paddingLeft:Scales.deviceWidth * 0.005, paddingRight:Scales.deviceWidth * 0.005, borderTopWidth: 0.25, borderBottomWidth: 0.25,}}>
                                        <Text style={{ color:'white', fontSize: 16, padding:'5%', textAlign:'center' }}>Track</Text>
                                    </TouchableOpacity>
                                    <TouchableOpacity onPress={this.Click_Evaluate} style={{paddingLeft:Scales.deviceWidth * 0.005, paddingRight:Scales.deviceWidth * 0.005,}}>
                                        <Text style={{ color:'white', fontSize: 16,padding:'5%', textAlign:'center' }}>Evaluate</Text>
                                    </TouchableOpacity>
                                </View>
                            </View>
