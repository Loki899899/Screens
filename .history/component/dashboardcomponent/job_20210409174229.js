    ...
    render() {
        ...
        return (<React.Fragment>
            <View key={this.props} style={{ flex: 1, flexDirection: 'column', marginTop: 10,}}
                //onStartShouldSetResponder={() => {this.HideMenu()}}
            >
                <View 
                    style={{
                    width: Scales.deviceWidth * 0.95, minHeight: Scales.deviceHeight * 0.18, alignSelf: 'center', backgroundColor: '#3d3d46', borderRadius: 10, shadowColor: '#000',
                    ...
                    <View 
                        style={{ width: Scales.deviceWidth * 0.90, paddingTop: Scales.deviceHeight * 0.01, paddingLeft: Scales.deviceWidth * 0.028, flexDirection: 'row', opacity: opaci == true ? 1 : 0.3, }}
                    >
                        <View style={{ width: Scales.deviceWidth * 0.73, flexDirection: 'row', }}>
                            <Text style={{ fontSize: Scales.moderateScale(18), fontFamily: 'roboto-medium', textTransform: "capitalize", color: "#ffffff" }}>{this.props.data.job_title}</Text>
                            {/* {expired ? <Text style={{ fontFamily: "roboto-regular", textAlignVertical: "top", color: 'red', fontSize: Scales.moderateScale(8) }}>(Expired)</Text> : null} */}
                        </View>
                        <View style={{ width: Scales.deviceWidth * 0.17, alignItems: "center", justifyContent:'space-between', flexDirection:'row',}}
                            onTouchStart={(e) => {
                                e.stopPropagation()
                            }}
                        >
                            <ToggleSwitch
                                isOn={expired?false:value}
                                onColor={expired ? "#9d9d9d" : "#13d7a6"}
                                offColor="#9d9d9d"
                                disabled={expired?true:this.state.show_loader}
                    ...
                    <View style={{ borderRadius: 5, position: 'absolute', top: 5, right: 25, backgroundColor: '#52526c', width: Scales.deviceWidth * 0.3, zIndex: 100 }}
                        onTouchStart={(e) => {
                            e.stopPropagation()
                        }}
                    >
                        <View style={{ display: this.state.dotmenu, paddingTop: '4%', paddingBottom: '4%', }}>
                            <TouchableOpacity onPress={this.Renew_job} style={{ paddingLeft: Scales.deviceWidth * 0.025, paddingRight: Scales.deviceWidth * 0.005, }}>
                                <Text style={{ color: 'white', fontSize: 16, padding: '5%', }}>Renew Job</Text>
                            </TouchableOpacity>
                            <TouchableOpacity onPress={this.Click_Track} style={{ paddingLeft: Scales.deviceWidth * 0.025, paddingRight: Scales.deviceWidth * 0.005, borderTopWidth: 0.25, borderBottomWidth: 0.25, }}>
                                <Text style={{ color: 'white', fontSize: 16, padding: '5%', }}>Track</Text>
                            </TouchableOpacity>
                            <TouchableOpacity onPress={this.Click_Evaluate} style={{ paddingLeft: Scales.deviceWidth * 0.025, paddingRight: Scales.deviceWidth * 0.005, }}>
                                <Text style={{ color: 'white', fontSize: 16, padding: '5%', }}>Evaluate</Text>
                            </TouchableOpacity>
                        </View>
                    </View>


                    <View style={{ width: Scales.deviceWidth * 0.95, minHeight: Scales.deviceHeight * 0.04, flexDirection: 'row', opacity: opaci == true ? 1 : 0.3, paddingLeft: Scales.deviceHeight * 0.014, alignItems:'flex-end' }}>
                        <View style={{ width: Scales.deviceWidth * 0.75, flexDirection: 'row', alignItems: 'center', padding: Scales.deviceWidth * 0.005,  }}>
                            <Image source={require('../../assets/JobmaIcons/emp-name.png')} style={{ resizeMode: 'contain', width: Scales.deviceWidth * 0.03, height: Scales.deviceHeight * 0.03 }} />
                            <Text style={{ fontFamily: 'roboto-regular', fontSize: Scales.moderateScale(13), left: Scales.deviceWidth * 0.015, color: "#ffffff" }}>Recruiter name: <Text style={{ fontFamily: 'roboto-medium', }}>{this.props.data.catcher.fname} {this.props.data.catcher.lname}</Text></Text>
                        </View>
                    ...
                    <View style={{ width: Scales.deviceWidth * 0.95, height: Scales.deviceHeight * 0.02, flexDirection: 'row', alignItems: 'center', padding: Scales.deviceWidth * 0.002, opacity: opaci == true ? 1 : 0.3, paddingLeft: Scales.deviceWidth * 0.03 }}>

                        <Image source={require('../../assets/JobmaIcons/date-cal.png')} style={{ resizeMode: 'contain', width: Scales.deviceWidth * 0.03, height: Scales.deviceHeight * 0.03 }} />
                        <Text style={{ fontFamily: 'roboto-regular', fontSize: Scales.moderateScale(13), left: Scales.deviceWidth * 0.015, color: "#8b8b8b", }}>Posted on: <Text style={{ fontFamily: 'roboto-regular', fontSize: Scales.moderateScale(12), left: Scales.deviceWidth * 0.015 }}>{posted_date} </Text> </Text>
                        <Text style={{ fontFamily: 'roboto-regular', fontSize: Scales.moderateScale(13), left: Scales.deviceWidth * 0.015, color: "#8b8b8b" }}>Expiry date: <Text style={{ fontFamily: 'roboto-regular', fontSize: Scales.moderateScale(12), left: Scales.deviceWidth * 0.015 }}>{expired_date}</Text> </Text>


                    </View>
                    {/* JOB APPROVAL TO CODE AND TEST FOR OTHER AVAILABLE APPROVAL OPTIONS */}
                    <View style={{ width: Scales.deviceWidth * 0.95, height: Scales.deviceHeight * 0.03, flexDirection: 'row', alignItems: 'center', opacity: opaci == true ? 1 : 0.3, paddingLeft: Scales.deviceWidth * 0.03, marginBottom: Scales.deviceHeight * 0.005 }}>

                        <Image source={require('../../assets/JobmaIcons/briefcase-dark.png')} style={{ resizeMode: 'contain', width: Scales.deviceWidth * 0.03, height: Scales.deviceHeight * 0.03 }} />
                        <Text style={{ fontFamily: 'roboto-regular', fontSize: Scales.moderateScale(13), left: Scales.deviceWidth * 0.015, color: "#8b8b8b" }}>Job approval</Text>
                        {this.props.data.approval == "1" ? <Image source={require('../../assets/JobmaIcons/job-approval.png')} style={{ resizeMode: 'contain', width: Scales.deviceWidth * 0.04, height: Scales.deviceHeight * 0.03, left: Scales.deviceWidth * 0.035 }} /> : <Image source={require('../../assets/JobmaIcons/job-not-approved.png')} style={{ resizeMode: 'contain', width: Scales.deviceWidth * 0.04, height: Scales.deviceHeight * 0.03, left: Scales.deviceWidth * 0.035 }} />}



                    </View>

                    <View style={{flexDirection: 'row', paddingLeft: '1%', opacity: opaci == true ? 1 : 0.3, }}>

                        <View style={{ backgroundColor: '#52526c', borderRadius: 10, flexDirection:'row', padding:4, marginLeft:4, }}>
                            <View style={{ backgroundColor:'#ffffff' , height:Scales.deviceHeight * 0.018, width:Scales.deviceHeight * 0.018, justifyContent:'center', borderRadius:10,}}>
                            <Text style={{ fontSize: Scales.moderateScale(10), fontFamily: 'roboto-medium', textAlign: 'center', color: "#3c3c3c", borderRadius:5,  }}>{this.props.data.applicants}</Text>
                            </View>
                        ...
                        <View style={{ backgroundColor: '#52526c', borderRadius: 10, flexDirection:'row', padding:4, marginLeft:4, }}>
                            <View style={{ backgroundColor:'#ffffff' , height:Scales.deviceHeight * 0.018, width:Scales.deviceHeight * 0.018, justifyContent:'center', borderRadius:10,}}>
                            <Text style={{ fontSize: Scales.moderateScale(10), fontFamily: 'roboto-medium', textAlign: 'center', color: "#3c3c3c", borderRadius:5,  }}>{this.props.data.invited}</Text>
                            </View>
                        ...
                        <View style={{ backgroundColor: '#52526c', borderRadius: 10, flexDirection:'row', padding:4, marginLeft:4, }}>
                            <View style={{ backgroundColor:'#ffffff' , height:Scales.deviceHeight * 0.018, width:Scales.deviceHeight * 0.018, justifyContent:'center', borderRadius:10,}}>
                            <Text style={{ fontSize: Scales.moderateScale(10), fontFamily: 'roboto-medium', textAlign: 'center', color: "#3c3c3c", borderRadius:5,  }}>{this.props.data.selected}</Text>
                            </View>
                        ...
                        <View style={{ backgroundColor: '#52526c', borderRadius: 10, flexDirection:'row', padding:4, marginLeft:4, }}>
                            <View style={{ backgroundColor:'#ffffff' , height:Scales.deviceHeight * 0.018, width:Scales.deviceHeight * 0.018, justifyContent:'center', borderRadius:10,}}>
                            <Text style={{ fontSize: Scales.moderateScale(10), fontFamily: 'roboto-medium', textAlign: 'center', color: "#3c3c3c", borderRadius:5,  }}>{this.props.data.hold}</Text>
                            </View>
                        ...
                        <View style={{ backgroundColor: '#52526c', borderRadius: 10, flexDirection:'row', padding:4, marginLeft:4, }}>
                            <View style={{ backgroundColor:'#ffffff' , height:Scales.deviceHeight * 0.018, width:Scales.deviceHeight * 0.018, justifyContent:'center', borderRadius:10,}}>
                            <Text style={{ fontSize: Scales.moderateScale(10), fontFamily: 'roboto-medium', textAlign: 'center', color: "#3c3c3c", borderRadius:5,  }}>{this.props.data.rejected}</Text>
                            </View>
