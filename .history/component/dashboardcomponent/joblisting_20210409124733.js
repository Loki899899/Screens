    ...
    render() {
        ...
        return (
            <SafeAreaView style={{ flex: 1 }}>
                <View style={{ flex: 1, }} onStartShouldSetResponder={() => {this.HideMenu()}}>
                    ...
                    <View style={{ flex: 1, backgroundColor: '#2d2d3a' }}>
                        ...
                        <TouchableOpacity
                            ...
                            <TouchableOpacity
                                style={{ backgroundColor: this.state.selected_filter_button==='Expired'?'#13d7a6':'#52526c', borderRadius: 20, marginLeft:'1%', }}
                                onPress={() => {
                                    this.setState({selected_filter_button:'Expired'})
                                }}
                            >
                                <Text style={{
                                    color: this.state.selected_filter_button==='Expired'?'black':'white',
                                    fontSize: 12,
                                    padding: '3%',
                                    paddingLeft: '6%',
                                    paddingRight: '6%'
                        ...
                        {this.state.job_list.length == 0 ?
                            ...
                            /> : <FlatList
                                    data={this.state.job_list}
                                    keyExtractor={(item, index) => index.toString()}
                                    renderItem={({ item }) => <Jobs date_format={this.state.date_format} data={item} dotmenu={this.state.dotmenu} navigation={this.props.navigation} />}
                                    windowSize={21}
                                    onRefresh={this._refresh}
                                    refreshing={this.state.refreshing}
