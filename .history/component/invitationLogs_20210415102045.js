        ...
        return (
            <View style={{ flex:1, backgroundColor: '#2d2d3a', padding:'5%'}}>
                ...
                <View style={{backgroundColor:'white', borderRadius:5}}>
                    {/* <View></View> */}
                    <View style={{marginTop:'-5%', width: Scales.deviceHeight * 0.08, justifyContent: "center", height: Scales.deviceHeight * 0.08, borderRadius: (Scales.deviceHeight * 0.08) / 2, alignSelf: "center", backgroundColor: this.props.index % 2 == 0 ? '#ffa001' : '#ff5367', elevation: 3 }}>
