...
class Logs extends Component {
    ...
    render() {
        ...
        return (
            <View style={{ flex:1, backgroundColor: '#2d2d3a', padding:'5%'}}>
                ...
                <View style={{ backgroundColor: 'white', borderRadius: 5 }}>
                    ...
                    <View style={{ backgroundColor: 'grey', marginTop: '-7%', borderRadius: 5, padding: '5%' }}>
                        <View style={{ borderRadius: 5, justifyContent: "center", }}>
                            <Text style={{  minHeight: Scales.deviceHeight * 0.025, fontFamily: "roboto-regular", textAlign: "left", borderRadius: 5, color: "#2d2d3a", backgroundColor: 'white', fontSize: Scales.moderateScale(11), padding: 2.5, textAlign: "center" }}>{this.props.data.interview_mode == 1 ? "Pre-recorded Interview" : "Live-Interview"}</Text>
                        </View>
