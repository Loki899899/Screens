...
class Logs extends Component {
    ...
    render() {
        ...
        return (
            <View style={{ flex:1, backgroundColor: '#2d2d3a', padding:'3%', paddingLeft:'5%', paddingRight:'5%',}}>

                <View style={{ height: Scales.deviceWidth * 0.16, borderWidth: this.props.index != 0 ? 0.8 : 0, alignSelf: "center", borderColor: "#c7c7c7", borderRadius: 0.01, borderStyle: "dashed" }}></View>
