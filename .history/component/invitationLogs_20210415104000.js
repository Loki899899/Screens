                ...
                <View style={{ borderRadius: 5 }}>
                    ...
                    <View style={{ backgroundColor: 'grey', marginTop: '-7%', borderRadius: 5, padding: '5%' }}>
                        ...
                        <View style={{ width: Scales.deviceWidth * 0.71, }}>
                            <Text style={{ color: "white", fontSize: Scales.moderateScale(12), paddingTop: 2, fontFamily: "roboto-regular", paddingLeft: 3 }}>Invited by: <Text style={{fontFamily: "roboto-regular", fontSize: Scales.moderateScale(12),}}>{String(this.props.data.employer_email)}</Text></Text>
                            {this.props.data.interview_mode == 1 ? <Text style={{ color: "white", fontSize: Scales.moderateScale(12), paddingTop: 2, fontFamily: "roboto-regular", paddingLeft: 3 }}>Interview kit : <Text style={{fontFamily: "roboto-regular", fontSize: Scales.moderateScale(12),}}>{String(this.props.data.kit_name)}</Text></Text> : null}
                        </View>
                    </View>
                </View>
