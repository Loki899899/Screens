        ...
        return (
            <View style={{ flex:1, backgroundColor: '#2d2d3a', paddingLeft:'5%', paddingRight:'5%',}}>
                ...
                <View style={{ borderRadius: 5 }}>
                    {/* <View></View> */}
                    <View style={{ width: Scales.deviceHeight * 0.08, justifyContent: "center", height: Scales.deviceHeight * 0.08, borderRadius: (Scales.deviceHeight * 0.08) / 2, alignSelf: "center", backgroundColor: '#13d7a6', borderWidth: 2, elevation: 1 }}>
                        <Text style={{ color: "#2d2d3a", fontSize: 18, alignSelf: 'center', textTransform: "capitalize" }}>{this.props.data.name.slice(0, 2)}</Text>
                    </View>
                    <View style={{ backgroundColor: 'grey', marginTop: '-7%', borderRadius: 5, padding: '5%' }}>
                        <View style={{ borderRadius: 5, justifyContent: "center", }}>
                            <Text style={{ maxWidth: Scales.deviceWidth * 0.35, minHeight: Scales.deviceHeight * 0.025, fontFamily: "roboto-regular", textAlign: "left", borderRadius: 5, color: "#2d2d3a", backgroundColor: 'white', fontSize: Scales.moderateScale(11), padding: 2.5, textAlign: "center" }}>{this.props.data.interview_mode == 1 ? "Pre-recorded Interview" : "Live-Interview"}</Text>
                        </View>
                        ...
                        <View style={{ width: Scales.deviceWidth * 0.65, minHeight: Scales.deviceHeight * 0.04, alignItems: "center", justifyContent: "space-between", flexDirection: "row" }}>
                            <View style={{ width: Scales.deviceWidth * 0.25, backgroundColor:'white', minHeight: Scales.deviceHeight * 0.04, flexDirection: "row", alignItems: "center" }}>
                                <Image source={require('../assets/JobmaIcons/calendar-lightBlue.png')} style={{width:14, height:14}}></Image>
                            ...
                            <View style={{ width: Scales.deviceWidth * 0.35, backgroundColor:'blue', minHeight: Scales.deviceHeight * 0.04, flexDirection: "row", alignItems: 'center' }}>
                                <Image source={require('../assets/Images/job_listing/public.png')} style={{width:14, height:14}}></Image>
                        ...
                        <View style={{ width: Scales.deviceWidth * 0.71, }}>
                            <Text style={{ color: "white", fontSize: Scales.moderateScale(12), paddingTop: 2, fontFamily: "roboto-regular", paddingLeft: 3 }}>Invited by: <Text style={{fontFamily: "roboto-regular", fontSize: Scales.moderateScale(12), color:'#3d3d46'}}>{String(this.props.data.employer_email)}</Text></Text>
                            {this.props.data.interview_mode == 1 ? <Text style={{ color: "white", fontSize: Scales.moderateScale(12), paddingTop: 2, fontFamily: "roboto-regular", paddingLeft: 3 }}>Interview kit : <Text style={{fontFamily: "roboto-regular", fontSize: Scales.moderateScale(12), color:'#3d3d46'}}>{String(this.props.data.kit_name)}</Text></Text> : null}
                        </View>
                    </View>
                </View>
