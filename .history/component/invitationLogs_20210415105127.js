                    ...
                    <View style={{ backgroundColor: 'grey', marginTop: '-7%', borderRadius: 5, padding: '5%' }}>
                        ...
                        <View style={{ width: Scales.deviceWidth * 0.53, minHeight: Scales.deviceHeight * 0.04, alignItems: "center", justifyContent: "space-between", flexDirection: "row" }}>
                            <View style={{ width: Scales.deviceWidth * 0.25, minHeight: Scales.deviceHeight * 0.04, flexDirection: "row", alignItems: "center" }}>
                                ...
                                <Text style={{ color: "#3c3c3c", fontSize: Scales.moderateScale(12), fontFamily: "roboto-regular", paddingTop: 2, paddingLeft: 6 }}>{moment(created_date).format(this.state.date_format)}</Text>
                            </View>
                            <View style={{ width: Scales.deviceWidth * 0.25, minHeight: Scales.deviceHeight * 0.04, flexDirection: "row", alignItems: 'center' }}>
                                <Image source={require('../assets/Images/job_listing/public.png')} style={{width:14, height:14}} resizeMode='contain'></Image>
                                <Text style={{ color: "#3c3c3c", fontSize: Scales.moderateScale(12), paddingTop: 2, fontFamily: "roboto-regular", paddingLeft: 6 }}>{(String(this.props.data.created_date).split(",")[1]).slice(1, (String(this.props.data.created_date).split(",")[1]).length)}</Text>
                            </View>
                        </View>
