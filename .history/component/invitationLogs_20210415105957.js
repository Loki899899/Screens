            ...
            <View style={{ flex:1, backgroundColor: '#2d2d3a', paddingLeft:'5%', paddingRight:'5%',}}>
                ...
                <View style={{ borderRadius: 5 }}>
                    ...
                    <View style={{  padding: 5, justifyContent: 'center', borderRadius: 5, alignSelf:'flex-end'}}>
                            <Text style={{ color:'white', backgroundColor:'#52526c', fontFamily: "roboto-regular", textAlign: 'center', paddingLeft: 8, borderRadius: 2, paddingTop: 2, paddingBottom: 2, fontSize: 10, }}>{this.props.data.msg}</Text>
                        </View>
                </View>
