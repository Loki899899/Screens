        ...
        return (
            <View style={{ flex:1, backgroundColor: '#2d2d3a', paddingLeft:'5%', paddingRight:'5%',}}>
                ...
                <View style={{ borderRadius: 5 }}>
                    ...
                    <View style={{marginTop:'-3%', marginRight:7, padding: 5, paddingTop: 2, paddingBottom: 2, backgroundColor:'#52526c', justifyContent: 'center', borderRadius: 5, alignSelf:'flex-end', alignItems:'center'}}>
