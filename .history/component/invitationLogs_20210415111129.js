            ...
            <View style={{ flex:1, backgroundColor: '#2d2d3a', paddingLeft:'5%', paddingRight:'5%',}}>
                ...
                <View style={{ borderRadius: 5 }}>
                    ...
                    <View style={{ backgroundColor: '#3d3d46', marginTop: '-7%', borderRadius: 5, padding: '5%' }}>
                        ...
                        <View style={{ backgroundColor:'green',width: Scales.deviceWidth * 0.53, height: Scales.deviceHeight * 0.03, alignItems: "center", justifyContent: "space-between", flexDirection: "row" }}>
                            ...
                            <View style={{ width: Scales.deviceWidth * 0.25, minHeight: Scales.deviceHeight * 0.036, flexDirection: "row", alignItems: 'center' }}>
                        ...
                        <View style={{ backgroundColor:'blue', width: Scales.deviceWidth * 0.71, minHeight: Scales.deviceHeight * 0.03, flexDirection: "row", alignItems:'center'}}>
                        ...
                        <View style={{ backgroundColor:'red', width: Scales.deviceWidth * 0.71, }}>
