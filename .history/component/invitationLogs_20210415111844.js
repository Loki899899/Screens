                ...
                <View style={{ borderRadius: 5 }}>
                    ...
                    <View style={{ backgroundColor: '#3d3d46', marginTop: '-7%', borderRadius: 5, padding: '5%' }}>
                        ...
                        <View style={{ width: Scales.deviceWidth * 0.71, }}>
                            ...
                            {this.props.data.interview_mode == 1 ? <Text style={{ color: "white", fontSize: Scales.moderateScale(12), paddingTop: 2, fontFamily: "roboto-regular", }}>Interview kit : <Text style={{ fontFamily: "roboto-regular", fontSize: Scales.moderateScale(12), color: '#8b8b8b' }}>{String(this.props.data.kit_name)}</Text></Text> : null}
                        </View>
                    </View>
