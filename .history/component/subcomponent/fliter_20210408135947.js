...
export default class Filter extends Component {
    ...
    render() {
        const header = <View style={{ flexDirection: "row", width: Scales.deviceWidth * 1.0, height: Scales.deviceHeight * 0.07, backgroundColor: '#483da8', }}>
                ...
                <View style={{ flex: 1, backgroundColor: "white" }}>
                    ...
                    <View>
                        <View style={{ width: Scales.deviceWidth * 1.0, height: Scales.deviceHeight * 0.80, flexDirection: 'row', }}>
                            ...
                            <View style={{ width: Scales.deviceWidth * 0.43, height: Scales.deviceHeight * 0.85 }}>
                                <TouchableOpacity onPress={() => this.setState({ account: 0, keyword: 1, post_btw: 0, apporve: 0, status: 0 })}>
                                    <View style={{ width: Scales.deviceWidth * 0.43, height: Scales.deviceHeight * 0.07, justifyContent: "flex-end" }}>
                        ...
                        <View style={{ width: Scales.deviceWidth * 1.0, height: Scales.deviceHeight * 0.065, }}>
                            <TouchableOpacity disabled={this.state.loader} onPress={() => this._refresh()}>
                                <View style={{ width: Scales.deviceWidth * 0.90, height: Scales.deviceHeight * 0.06, alignSelf: "center", backgroundColor: "#483da8", justifyContent: "center", borderRadius: 10 }}>
                                    <Text style={{ fontFamily: "roboto-medium", color: "white", fontSize: Scales.moderateScale(20), textAlign: "center" }}>Apply</Text>
