    ...
    render() {
        const header = <View style={{ flexDirection: "row", width: Scales.deviceWidth * 1.0, height: Scales.deviceHeight * 0.07, backgroundColor: '#2c2c39', }}>
            ...
            <TouchableOpacity onPress={() => this.HeaderBack()}><View style={{ width: Scales.deviceWidth * 0.12, height: Scales.deviceHeight * 0.07, justifyContent: 'center', alignItems: "center", }}>
                <Image source={require('../../assets/Images/back_button.png')} style={{ resizeMode: "contain", height: Scales.deviceHeight * 0.035, aspectRatio: 0.6 }} />
            </View></TouchableOpacity>

            <View style={{ width: Scales.deviceWidth * 0.80, height: Scales.deviceHeight * 0.07, alignItems: 'center', flexDirection: 'row', }}>
                <View style={{ width: "50%", height: Scales.deviceHeight * 0.07, justifyContent: "center", paddingLeft: 3 }}>
                    <Text style={{ fontFamily: 'roboto-medium', fontSize: Scales.moderateScale(20), textAlign: "left", color: 'white', }}>Filters</Text>

                </View>
                <View style={{ width: "50%", height: Scales.deviceHeight * 0.07, justifyContent: "center", paddingLeft: 3 }}>
                    <TouchableOpacity onPress={() => this.ClearAll()}><Text style={{ fontFamily: 'roboto-medium', fontSize: Scales.moderateScale(18), textAlign: "right", color: 'white', width: "100%", }}>Clear all</Text></TouchableOpacity>
        ...
        return (
            <SafeAreaView style={{ flex: 1 }}>
                <View style={{ flex: 1, backgroundColor: "#2c2c39" }}>
                    ...
                    {header}
                    <View>
                        <View style={{ width: Scales.deviceWidth * 1.0, height: Scales.deviceHeight * 0.80, flexDirection: 'row',}}>

                            <View style={{ width: Scales.deviceWidth * 0.43, height: Scales.deviceHeight * 0.9, backgroundColor:'grey' }}>
                                <TouchableOpacity onPress={() => this.setState({ account: 0, keyword: 1, post_btw: 0, apporve: 0, status: 0 })}>
                                    <View style={{ width: Scales.deviceWidth * 0.43, height: Scales.deviceHeight * 0.07, justifyContent: "center", backgroundColor:this.state.keyword===1?'#2c2c39':'transparent' }}>
                                        {/* <View style={{ width: Scales.deviceWidth * 0.32, height: Scales.deviceHeight * 0.05, borderRadius: 10, alignSelf: 'center', justifyContent: 'center', backgroundColor: this.state.keyword == 1 ? '#4539a6' : '#f9f9f9', borderWidth: 0.3, borderColor: "#bdbdbd" }}> */}
                                            <Text style={{ textAlign: "center", color: this.state.keyword == 1 ? "white" : "#3c3c3c", fontSize: Scales.moderateScale(14), fontFamily: "roboto-medium" }}>Keywords</Text>
                                ...
                                <TouchableOpacity onPress={() => this.setState({ account: 0, keyword: 0, post_btw: 0, apporve: 1, status: 0 })}><View style={{ width: Scales.deviceWidth * 0.43, height: Scales.deviceHeight * 0.07, justifyContent: "flex-end" }}>
                                    ...
                                    <View style={{ width: Scales.deviceWidth * 0.43, height: Scales.deviceHeight * 0.07, justifyContent: "center", backgroundColor:this.state.apporve===1?'#2c2c39':'transparent' }}>
                                        <Text style={{ textAlign: "center", fontFamily: "roboto-medium", color: this.state.apporve == 1 ? "white" : "#3c3c3c", fontSize: Scales.moderateScale(14) }}>Approval</Text>
                                    </View>
                                    {/* </View> */}
                                </View></TouchableOpacity>
                                ...
                                <TouchableOpacity onPress={() => this.setState({ account: 0, keyword: 0, post_btw: 0, apporve: 0, status: 1 })}><View style={{ width: Scales.deviceWidth * 0.43, height: Scales.deviceHeight * 0.07, justifyContent: "flex-end" }}>
                                    ...
                                    <View style={{ width: Scales.deviceWidth * 0.43, height: Scales.deviceHeight * 0.07, justifyContent: "center", backgroundColor:this.state.status===1?'#2c2c39':'transparent' }}>
                                        <Text style={{ textAlign: "center", fontFamily: "roboto-medium", color: this.state.status == 1 ? "white" : "#3c3c3c", fontSize: Scales.moderateScale(14) }}>Status</Text>
                                    </View>
                                </View></TouchableOpacity>
                                ...
                                <TouchableOpacity onPress={() => this.setState({ account: 0, keyword: 0, post_btw: 1, apporve: 0, status: 0 })}><View style={{ width: Scales.deviceWidth * 0.43, height: Scales.deviceHeight * 0.07, justifyContent: "flex-end" }}>
                                    ...
                                    <View style={{ width: Scales.deviceWidth * 0.43, height: Scales.deviceHeight * 0.07, justifyContent: "center", backgroundColor:this.state.post_btw===1?'#2c2c39':'transparent' }}>
                                        <Text style={{ textAlign: "center", fontFamily: "roboto-medium", color: this.state.post_btw == 1 ? "white" : "#3c3c3c", fontSize: Scales.moderateScale(14) }}>Posted Between</Text>
                                    </View>
                                </View></TouchableOpacity>

                                <TouchableOpacity onPress={() => this.setState({ account: 1, keyword: 0, post_btw: 0, apporve: 0, status: 0 })}><View style={{ width: Scales.deviceWidth * 0.43, height: Scales.deviceHeight * 0.07, justifyContent: "flex-end" }}>
                                    ...
                                    <View style={{ width: Scales.deviceWidth * 0.43, height: Scales.deviceHeight * 0.07, justifyContent: "center", backgroundColor:this.state.account===1?'#2c2c39':'transparent' }}>
                                        <Text style={{ textAlign: "center", fontFamily: "roboto-medium", color: this.state.account == 1 ? "white" : "#3c3c3c", fontSize: Scales.moderateScale(14) }}>Accounts</Text>
                                    </View>
                                </View></TouchableOpacity>
                            ...
                            {this.state.apporve == 1 ?
                                <View style={{ width: Scales.deviceWidth * 0.57, opacity: this.state.disapproved_status == false && this.state.approved_status == false ? 0.5 : 1, height: Scales.deviceHeight * 0.15, justifyContent: 'center', }}>
                                    <View style={{ width: Scales.deviceWidth * 0.57, paddingLeft: Scales.deviceWidth * 0.03, opacity: this.state.disapproved_status == true && this.state.approved_status == false ? 0.5 : 1, height: Scales.deviceHeight * 0.06, alignItems: "center", flexDirection: "row" }}>
                                        ...
                                        <Text style={{ fontSize: Scales.moderateScale(14), fontFamily: "roboto-medium", paddingLeft: Scales.deviceWidth * 0.015, color: "#3c3c3c", }}>Approved</Text>
                                    ...
                                    <View style={{ width: Scales.deviceWidth * 0.57, paddingLeft: Scales.deviceWidth * 0.03, opacity: this.state.disapproved_status == false && this.state.approved_status == true ? 0.5 : 1, height: Scales.deviceHeight * 0.06, alignItems: "center", flexDirection: "row" }}>
                                        ...
                                        <Text style={{ fontSize: Scales.moderateScale(14), fontFamily: "roboto-medium", paddingLeft: Scales.deviceWidth * 0.015, color: "#3c3c3c" }}>Disapproved</Text>
                            ...
                            {this.state.status == 1 ? <View style={{ width: Scales.deviceWidth * 0.57, height: Scales.deviceHeight * 0.20, justifyContent: 'center', }}>
                                <View style={{ width: Scales.deviceWidth * 0.57, paddingLeft: Scales.deviceWidth * 0.03, height: Scales.deviceHeight * 0.06, alignItems: "center", flexDirection: "row" }}>
                                    ...
                                    <Text style={{ fontSize: Scales.moderateScale(14), fontFamily: "roboto-medium", paddingLeft: 5, color: "#3c3c3c" }}>Activated</Text>
                                ...
                                <View style={{ width: Scales.deviceWidth * 0.57, paddingLeft: Scales.deviceWidth * 0.03, height: Scales.deviceHeight * 0.06, alignItems: "center", flexDirection: "row" }}>
                                    ...
                                    <Text style={{ fontSize: Scales.moderateScale(14), fontFamily: "roboto-medium", paddingLeft: 5, color: "#3c3c3c" }}>Deactivated</Text>
                                ...
                                <View style={{ width: Scales.deviceWidth * 0.57, paddingLeft: Scales.deviceWidth * 0.03, height: Scales.deviceHeight * 0.06, alignItems: "center", flexDirection: "row" }}>
                                    ...
                                    <Text style={{ fontSize: Scales.moderateScale(14), fontFamily: "roboto-medium", paddingLeft: 5, color: "#3c3c3c" }}>Expired Jobs</Text>
    ...
    render() {
        return (
            <View style={{ width: Scales.deviceWidth * 0.40, height: Scales.deviceHeight * 0.06, alignItems: 'center', flexDirection: "row" }}>
                ...
                <Text style={{ fontSize: Scales.moderateScale(12), fontFamily: 'roboto-medium', textTransform: "capitalize", color: "#3c3c3c" }}>
