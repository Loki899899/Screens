                        ...
                        <View style={{ width: Scales.deviceWidth * 1.0, height: Scales.deviceHeight * 0.80, flexDirection: 'row',}}>
                            ...
                            <View style={{ width: Scales.deviceWidth * 0.43, height: Scales.deviceHeight * 0.9, backgroundColor:'grey' }}>
                                <TouchableOpacity onPress={() => this.setState({ account: 0, keyword: 1, post_btw: 0, apporve: 0, status: 0 })}>
                                    <View style={{ width: Scales.deviceWidth * 0.43, height: Scales.deviceHeight * 0.07, justifyContent: "center", alignItems:'flex-start', paddingLeft:Scales.deviceWidth * 0.001,backgroundColor:this.state.keyword===1?'#2c2c39':'transparent' }}>
                                ...
                                <TouchableOpacity onPress={() => this.setState({ account: 0, keyword: 0, post_btw: 0, apporve: 1, status: 0 })}><View style={{ width: Scales.deviceWidth * 0.43, height: Scales.deviceHeight * 0.07, justifyContent: "flex-end" }}>
                                    ...
                                    <View style={{ width: Scales.deviceWidth * 0.43, height: Scales.deviceHeight * 0.07, justifyContent: "center", alignItems:'flex-start', backgroundColor:this.state.apporve===1?'#2c2c39':'transparent' }}>
                                ...
                                <TouchableOpacity onPress={() => this.setState({ account: 0, keyword: 0, post_btw: 0, apporve: 0, status: 1 })}><View style={{ width: Scales.deviceWidth * 0.43, height: Scales.deviceHeight * 0.07, justifyContent: "flex-end" }}>
                                    ...
                                    <View style={{ width: Scales.deviceWidth * 0.43, height: Scales.deviceHeight * 0.07, justifyContent: "center", alignItems:'flex-start', backgroundColor:this.state.status===1?'#2c2c39':'transparent' }}>
                                ...
                                <TouchableOpacity onPress={() => this.setState({ account: 0, keyword: 0, post_btw: 1, apporve: 0, status: 0 })}><View style={{ width: Scales.deviceWidth * 0.43, height: Scales.deviceHeight * 0.07, justifyContent: "flex-end" }}>
                                    ...
                                    <View style={{ width: Scales.deviceWidth * 0.43, height: Scales.deviceHeight * 0.07, justifyContent: "center", alignItems:'flex-start', backgroundColor:this.state.post_btw===1?'#2c2c39':'transparent' }}>
                                ...
                                <TouchableOpacity onPress={() => this.setState({ account: 1, keyword: 0, post_btw: 0, apporve: 0, status: 0 })}><View style={{ width: Scales.deviceWidth * 0.43, height: Scales.deviceHeight * 0.07, }}>
                                    ...
                                    <View style={{ width: Scales.deviceWidth * 0.43, height: Scales.deviceHeight * 0.07, justifyContent: "center", alignItems:'flex-start', backgroundColor:this.state.account===1?'#2c2c39':'transparent' }}>
