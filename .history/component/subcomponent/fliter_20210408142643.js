        ...
        return (
            <SafeAreaView style={{ flex: 1 }}>
                <View style={{ flex: 1, backgroundColor: "#2c2c39" }}>
                    ...
                    {header}
                    <View style={{height: Scales.deviceHeight * 0.90, backgroundColor:'green'}}>
                    ...
                    <View>
                            <TouchableOpacity
                                disabled={this.state.loader} onPress={() => this._refresh()}>
                                    {/* <View style={{ width: Scales.deviceWidth * 0.90, height: Scales.deviceHeight * 0.06, alignSelf: "center", backgroundColor: "#13d7a6", justifyContent: "center", borderRadius: 10 }}></View> */}
                                <Text>Apply</Text>
                            </TouchableOpacity>
                        </View>
                    <Modal
