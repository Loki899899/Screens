        ...
        return (
            <SafeAreaView style={{ flex: 1 }}>
                <View style={{ flex: 1, backgroundColor: "#2c2c39" }}>
                    ...
                    {header}
                    <View style={{height: Scales.deviceHeight * 0.925, backgroundColor:'green'}}>
                        <View style={{ width: Scales.deviceWidth * 1.0, height: Scales.deviceHeight * 0.925, flexDirection: 'row',}}>

                            <View style={{ width: Scales.deviceWidth * 0.43, height: Scales.deviceHeight * 0.925, backgroundColor:'grey' }}>
                    ...
                    <View style={{flexDirection:'row', alignItems:'flex-end', backgroundColor:'white', height: Scales.deviceHeight * 0.075,}}>
