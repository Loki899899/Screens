    ...
    render() {
        const header = <View style={{ flexDirection: "row", width: Scales.deviceWidth * 1.0, height: Scales.deviceHeight * 0.07, backgroundColor: '#2c2c39', }}>
            ...
            <View style={{ width: Scales.deviceWidth * 0.80, height: Scales.deviceHeight * 0.07, alignItems: 'center', flexDirection: 'row',}}>
                ...
                <View style={{ width: "45%", height: Scales.deviceHeight * 0.07, justifyContent: "center", paddingLeft: 3 }}>
                    <TouchableOpacity onPress={() => this.ClearAll()}>
                        <View style={{flexDirection:'row', alignItems:'center', alignContent:'flex-start', backgroundColor:'green'}}>
                        <Image
                            source={require('./../../assets/JobmaIcons/close.png')}
                            style={{width:10, height:10,}}
                        ></Image>
                        <Text style={{ fontFamily: 'roboto-medium', fontSize: Scales.moderateScale(12), textAlign: "right", color: 'white', width: "100%", }}>Clear all</Text>
                        </View>
                    </TouchableOpacity>
                </View>
            </View>
