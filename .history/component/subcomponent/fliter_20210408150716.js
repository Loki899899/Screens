        ...
        return (
            <SafeAreaView style={{ flex: 1 }}>
                <View style={{ flex: 1, backgroundColor: "#2c2c39" }}>
                    ...
                    <View style={{flexDirection:'row', alignItems:'flex-end', backgroundColor:'#2c2c39', paddingBottom:Scales.deviceHeight*0.01, height: Scales.deviceHeight * 0.075, justifyContent:'space-around', borderTopColor:'grey', borderTopWidth:0.5}}>
