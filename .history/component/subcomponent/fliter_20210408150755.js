        ...
        return (
            <SafeAreaView style={{ flex: 1 }}>
                <View style={{ flex: 1, backgroundColor: "#2c2c39" }}>
                    ...
                    {header}
                    <View style={{height: Scales.deviceHeight * 0.92,}}>
                        <View style={{ width: Scales.deviceWidth * 1.0, height: Scales.deviceHeight * 0.92, flexDirection: 'row',}}>

                            <View style={{ width: Scales.deviceWidth * 0.43, height: Scales.deviceHeight * 0.92, backgroundColor:'grey' }}>
                    ...
                    <View style={{flexDirection:'row', alignItems:'flex-end', backgroundColor:'#2c2c39', paddingBottom:Scales.deviceHeight*0.01, height: Scales.deviceHeight * 0.08, justifyContent:'space-around', borderTopColor:'grey', borderTopWidth:0.5}}>
