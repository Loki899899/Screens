                    ...
                    <View style={{height: Scales.deviceHeight * 0.915,}}>
                        <View style={{ width: Scales.deviceWidth * 1.0, height: Scales.deviceHeight * 0.915, flexDirection: 'row',}}>
                            ...
                            {this.state.status == 1 ? <View style={{ width: Scales.deviceWidth * 0.57, height: Scales.deviceHeight * 0.20, justifyContent: 'center', }}>
                                <View style={{ width: Scales.deviceWidth * 0.57, opacity: this.state.disapproved_status == false && this.state.approved_status == false ? 0.5 : 1, paddingLeft: Scales.deviceWidth * 0.03, height: Scales.deviceHeight * 0.06, alignItems: "center", flexDirection: "row" }}>
                                ...
                                <View style={{ width: Scales.deviceWidth * 0.57, opacity: this.state.deactivate == false && this.state.approved_status == false ? 0.5 : 1, paddingLeft: Scales.deviceWidth * 0.03, height: Scales.deviceHeight * 0.06, alignItems: "center", flexDirection: "row" }}>
                                ...
                                <View style={{ width: Scales.deviceWidth * 0.57, opacity: this.state.expired == false? 0.5 : 1, paddingLeft: Scales.deviceWidth * 0.03, height: Scales.deviceHeight * 0.06, alignItems: "center", flexDirection: "row" }}>
