                        ...
                        <View style={{ width: Scales.deviceWidth * 1.0, height: Scales.deviceHeight * 0.915, flexDirection: 'row',}}>
                            ...
                            {this.state.apporve == 1 ?
                                <View style={{ width: Scales.deviceWidth * 0.57, height: Scales.deviceHeight * 0.15, justifyContent: 'center', }}>
                                    <View style={{  backgroundColor:'red', width: Scales.deviceWidth * 0.5, opacity: this.state.disapproved_status == true && this.state.approved_status == false ? 0.5 : 1, height: Scales.deviceHeight * 0.06, alignItems: "center", flexDirection: "row" }}>
