                            ...
                            {this.state.apporve == 1 ?
                                <View style={{ width: Scales.deviceWidth * 0.57, height: Scales.deviceHeight * 0.15, justifyContent: 'center', }}>
                                    <View style={{  backgroundColor:'red', width: Scales.deviceWidth * 0.57, opacity: this.state.disapproved_status == true && this.state.approved_status == false ? 0.5 : 1, height: Scales.deviceHeight * 0.06, alignItems: "center", flexDirection: "row" }}>
                                        <CheckBox wrapperStyle={{ height: Scales.deviceHeight * 0.03 }} size={Scales.moderateScale(20)} containerStyle={{ height: Scales.deviceHeight * 0.05, justifyContent: "center", alignSelf: "flex-start" }} checked={this.state.approved_status} onPress={() => this.setState({ approved_status: !this.state.approved_status, disapproved_status: false })} />
