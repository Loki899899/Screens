                            ...
                            {this.state.apporve == 1 ?
                                <View style={{ width: Scales.deviceWidth * 0.57, height: Scales.deviceHeight * 0.15, justifyContent: 'center', }}>
                                    ...
                                    <View style={{ width: Scales.deviceWidth * 0.57, paddingLeft: Scales.deviceWidth * 0.03, height: Scales.deviceHeight * 0.06, alignItems: "center", flexDirection: "row" }}>
                                        <CheckBox containerStyle={{ height: "100%", justifyContent: "center", width: Scales.deviceHeight * 0.035 }} size={Scales.moderateScale(20)} containerStyle={{ height: Scales.deviceHeight * 0.05, width: Scales.deviceHeight * 0.035, justifyContent: "center", alignSelf: "flex-start" }} checked={this.state.disapproved_status} onPress={() => this.setState({ disapproved_status: !this.state.disapproved_status, approved_status: false })} />
