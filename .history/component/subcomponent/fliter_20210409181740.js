            ...
            <View style={{ width: Scales.deviceWidth * 0.80, height: Scales.deviceHeight * 0.07, alignItems: 'center', flexDirection: 'row',}}>
                ...
                <View style={{ width: "45%", height: Scales.deviceHeight * 0.07, justifyContent: "center", alignItems:'flex-end', paddingLeft: 3, }}>
                    ...
                    >
                        ...
                        <Image
                            source={require('./../../assets/JobmaIcons/delete-icon.png')}
                ...
                <View style={{ flex: 1, backgroundColor: "#2c2c39" }}>
                    ...
                    <View style={{height: Scales.deviceHeight * 0.915,}}>
                        <View style={{ width: Scales.deviceWidth * 1.0, height: Scales.deviceHeight * 0.915, flexDirection: 'row',}}>
                            ...
                            <View style={{ width: Scales.deviceWidth * 0.43, height: Scales.deviceHeight * 0.915, backgroundColor:'#3d3d46',}}>
                            ...
                            {this.state.keyword == 1 ? <View style={{ width: Scales.deviceWidth * 0.57, height: Scales.deviceHeight * 0.85, }}>
                                ...
                                <View style={{flexDirection:"row", alignItems:'flex-end',}}>
                                    <View style={{paddingBottom:'3%', borderBottomWidth: 0.3, }}>
                                    <Image
                                        source={require('../../assets/JobmaIcons/search-dark-theme.png')}
                                        style={{width:15, height:15,}}
                                    ></Image>
                                    </View>
                                    <TextInput placeholder="Enter your keywords"
                                    placeholderTextColor = {"white"}
                                        onChangeText={(text) => this.setState({ job_title: text })} 
                                        value={this.state.job_title}
                                        style={{ borderBottomWidth: 0.3, fontFamily: "roboto-regular", width: Scales.deviceWidth * 0.55, 
                                            paddingLeft: Scales.deviceWidth * 0.025, paddingBottom:0, fontSize: Scales.moderateScale(14), 
                                            backgroundColor: "#2d2d3a", minHeight: Scales.deviceHeight * 0.045, color: "white" }}
                                    ></TextInput>
                                </View>

                                {/* <View style={{ width: Scales.deviceWidth * 0.57, minHeight: Scales.deviceHeight * 0.10, justifyContent: 'center', }}>
                                    <TextInput placeholderTextColor = {"#c7c7c7"}  placeholder="Enter your keywords" placeholderTextColor={"#c7c7c7"} onChangeText={(text) => this.setState({ job_title: text })} value={this.state.job_title} style={{ borderWidth: 0.3, fontFamily: "roboto-regular", borderRadius: 5, width: Scales.deviceWidth * 0.55, paddingLeft: Scales.deviceWidth * 0.025, fontSize: Scales.moderateScale(10), backgroundColor: "#fafafa", minHeight: Scales.deviceHeight * 0.045, color: "#3c3c3c" }} />
                                </View> */}
                            </View> : null}

                            {this.state.apporve == 1 ?
                                <View style={{ width: Scales.deviceWidth * 0.57, height: Scales.deviceHeight * 0.15, justifyContent: 'center', }}>
                                    <View style={{  width: Scales.deviceWidth * 0.57, opacity: this.state.disapproved_status == true && this.state.approved_status == false ? 0.5 : 1, height: Scales.deviceHeight * 0.06, alignItems: "center", flexDirection: "row", paddingLeft:0 }}>
                                        <CheckBox wrapperStyle={{ height: Scales.deviceHeight * 0.05, width: Scales.deviceHeight * 0.035 }} size={Scales.moderateScale(20)} containerStyle={{ height: Scales.deviceHeight * 0.05, width: Scales.deviceHeight * 0.035, justifyContent: "center", alignSelf: "flex-start" }} checked={this.state.approved_status} onPress={() => this.setState({ approved_status: !this.state.approved_status, disapproved_status: false })} />
                                        <Text style={{ fontSize: Scales.moderateScale(14), fontFamily: "roboto-medium", color: "white", }}>Approved</Text>
                                        {/* <Text>Approved</Text> */}
                                    </View>

                                    <View style={{ width: Scales.deviceWidth * 0.57, paddingLeft: 0, height: Scales.deviceHeight * 0.06, alignItems: "center", flexDirection: "row" }}>
                                        <CheckBox containerStyle={{ height: "100%", justifyContent: "center", width: Scales.deviceHeight * 0.035 }} size={Scales.moderateScale(20)}  checked={this.state.disapproved_status} onPress={() => this.setState({ disapproved_status: !this.state.disapproved_status, approved_status: false })} />
                                        <Text style={{ fontSize: Scales.moderateScale(14), fontFamily: "roboto-medium", paddingLeft: 0, color: "white" }}>Disapproved</Text>
                            ...
                            {this.state.status == 1 ? <View style={{ width: Scales.deviceWidth * 0.57, height: Scales.deviceHeight * 0.20, justifyContent: 'center', }}>
                                <View style={{ width: Scales.deviceWidth * 0.57, paddingLeft: 0, height: Scales.deviceHeight * 0.06, alignItems: "center", flexDirection: "row" }}>
                                    <CheckBox containerStyle={{ height: "100%", justifyContent: "center", width: Scales.deviceHeight * 0.035 }} size={Scales.moderateScale(20)} checked={this.state.activate} onPress={() => this.setState({ activate: !this.state.activate, deactivate: false, expired: false, status_select: this.state.activate?null:String(1) })} />
                                    <Text style={{ fontSize: Scales.moderateScale(14), fontFamily: "roboto-medium", paddingLeft: 0, color: "white", }}>Activated</Text>

                                </View>

                                <View style={{ width: Scales.deviceWidth * 0.57, paddingLeft:0, height: Scales.deviceHeight * 0.06, alignItems: "center", flexDirection: "row" }}>
                                    <CheckBox containerStyle={{ height: "100%", justifyContent: "center", width: Scales.deviceHeight * 0.035 }} size={Scales.moderateScale(20)} checked={this.state.deactivate} onPress={() => this.setState({ activate: false, deactivate: !this.state.deactivate, expired: false, status_select:this.state.deactivate?null: String(0) })} />
                                    <Text style={{ fontSize: Scales.moderateScale(14), fontFamily: "roboto-medium", paddingLeft: 0, color: "white" }}>Deactivated</Text>

                                </View>

                                <View style={{ width: Scales.deviceWidth * 0.57, paddingLeft:0, height: Scales.deviceHeight * 0.06, alignItems: "center", flexDirection: "row" }}>
                                    <CheckBox containerStyle={{ height: "100%", justifyContent: "center", width: Scales.deviceHeight * 0.035 }} size={Scales.moderateScale(20)} checked={this.state.expired} onPress={() => this.setState({ activate: false, deactivate: false, expired: !this.state.expired, status_select:this.state.expired?null: String(2) })} />
                                    <Text style={{ fontSize: Scales.moderateScale(14), fontFamily: "roboto-medium", paddingLeft: 0, color: "white" }}>Expired Jobs</Text>
                            ...
                            {this.state.post_btw == 1 ? <View style={{ width: Scales.deviceWidth * 0.57, height: Scales.deviceHeight * 0.20, justifyContent: 'center', }}>
                                <TouchableOpacity onPress={() => this.setState({ modalvisible: !this.state.modalvisible })}><View style={{ width: Scales.deviceWidth * 0.55, borderRadius: 5, borderWidth: 0.3, height: Scales.deviceHeight * 0.05, alignItems: "center", flexDirection: "row", backgroundColor: this.state.selectedStartDate != null ? "green" : null }}>
                                    <View style={{ width: Scales.deviceWidth * 0.10, paddingLeft: Scales.deviceWidth * 0.03, height: Scales.deviceHeight * 0.05, justifyContent: "center" }}>
                                        <Image source={require("../../assets/JobmaIcons/date-cal.png")} style={{ resizeMode: "contain" }} />
                                    ...
                                    <View style={{ width: Scales.deviceWidth * 0.40, justifyContent: "center", paddingLeft: Scales.deviceWidth * 0.03, height: Scales.deviceHeight * 0.05, }}>
                                        ...
                                        <Text style={{ fontSize: Scales.moderateScale(12), fontFamily: 'roboto-medium', color: "white"}}>{this.state.selectedStartDate != null ? (String(moment(String(this.state.selectedStartDate)).format(this.state.date_format))) : "Select Start Date"}</Text>
                                    </View>
                                ...
                                <TouchableOpacity onPress={() => this.setState({ modalvisible_1: true })}>
                                    <View style={{ width: Scales.deviceWidth * 0.55, borderRadius: 5, borderWidth: 0.3, marginTop: Scales.deviceHeight * 0.015, height: Scales.deviceHeight * 0.05, alignItems: "center", flexDirection: "row", backgroundColor: this.state.selectedEndDate != null ? "green" : null }}>
                                        ...
                                        <View style={{ width: Scales.deviceWidth * 0.40, justifyContent: "center", paddingLeft: Scales.deviceWidth * 0.03, height: Scales.deviceHeight * 0.05, }}>
                                            ...
                                            <Text style={{ fontSize: Scales.moderateScale(12), fontFamily: 'roboto-medium', color: "white" }}>{this.state.selectedEndDate != null ? (String(moment(String(this.state.selectedEndDate)).format(this.state.date_format))) : "Select End Date"}</Text>
                                        </View>
                    ...
                    <View style={{flexDirection:'row', alignItems:'flex-end', backgroundColor:'#2c2c39', paddingBottom:Scales.deviceHeight*0.01, height: Scales.deviceHeight * 0.085, justifyContent:'space-around', borderTopColor:'grey', borderTopWidth:0.5}}>
                        <Text style={{color:'white', paddingBottom:Scales.deviceHeight*0.01, }}>{20} Jobs Found</Text>
                        <TouchableOpacity disabled={this.state.loader} onPress={() => this._refresh()}>
    ...
    render() {
        return (
            <View style={{ width: Scales.deviceWidth * 0.40, height: Scales.deviceHeight * 0.06, alignItems: 'center', flexDirection: "row" }}>
                <CheckBox containerStyle={{ height: "100%", justifyContent: "center", width: Scales.deviceHeight * 0.035 }} size={Scales.moderateScale(20)} checked={this.state.check} onPress={() => this.AddAccount(this.props.data.id)} />
                <Text style={{ fontSize: Scales.moderateScale(12), fontFamily: 'roboto-medium', textTransform: "capitalize", color: "white", }}>
