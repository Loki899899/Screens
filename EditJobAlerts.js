...
const Notification = () => {
    const [dailyDisplayState, setDailyDisplayState] = useState(true)
    const [monthlyDisplayState, setMonthlyDisplayState] = useState(false)
    const [yearlyDisplayState, setYearlyDisplayState] = useState(false)
    return (
        <View style={styles.section}>
            ...
            <TouchableOpacity
                style={styles.choiceTouchable}
                onPress={ () => {
                    setDailyDisplayState(true)
                    setMonthlyDisplayState(false)
                    setYearlyDisplayState(false)
                }}
            >
                {dailyDisplayState?<WithLinearGradient text='Daily' />:<WithoutLinearGradient text='Daily' />}
            </TouchableOpacity>
            <TouchableOpacity
                style={styles.choiceTouchable}
                onPress={ () => {
                    setDailyDisplayState(false)
                    setMonthlyDisplayState(true)
                    setYearlyDisplayState(false)
                }}
            >
                {monthlyDisplayState?<WithLinearGradient text='Monthly' />:<WithoutLinearGradient text='Monthly' />}
            </TouchableOpacity>
            <TouchableOpacity
                style={styles.choiceTouchable}
                onPress={ () => {
                    setDailyDisplayState(false)
                    setMonthlyDisplayState(false)
                    setYearlyDisplayState(true)
                }}
            >
                {yearlyDisplayState?<WithLinearGradient text='Yearly' />:<WithoutLinearGradient text='Yearly' />}
            </TouchableOpacity>
            </View>
        </View>
    );
            ...
            <ImageBackground source={require('./android/app/src/main/assets/images/bg-blue.png')} style={styles.bgimg}>
                <View style={styles.filterContainer}>
                    ...
                    <View style={styles.buttonsContainer}>
                        ...
                        >
                            <Text style={{textAlign:'center', color:'white', fontWeight:'bold',}}>Save Alert</Text>
                        </TouchableOpacity>
                    </View>
                </View>
            </ImageBackground>
